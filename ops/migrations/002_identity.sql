-- Generated with Better Auth 1.7.2 getMigrations/compileMigrations.
-- Migration 002: provider identity tables, after D01 schemas exist.
SET LOCAL search_path = identity;
...
-- Restore the migration metadata namespace within the shared transaction.
