// @zoen-plan tests/admission/spec-000/execution-lock.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/admission/spec-000/execution-lock.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/admission/spec-000/execution-lock.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
