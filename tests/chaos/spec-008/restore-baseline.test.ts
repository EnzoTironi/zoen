// @zoen-plan tests/chaos/spec-008/restore-baseline.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/chaos/spec-008/restore-baseline.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/chaos/spec-008/restore-baseline.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
