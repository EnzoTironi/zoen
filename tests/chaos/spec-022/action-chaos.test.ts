// @zoen-plan tests/chaos/spec-022/action-chaos.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/chaos/spec-022/action-chaos.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/chaos/spec-022/action-chaos.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0134 [required layer=chaos; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0134-AC:
//     ARRANGE A read predicate changes after the final preview but before commitment
//     ACT The full action journey runs
//     ASSERT The result is Stale with no local/external effect; unchanged authorized retries resolve one receipt
