// @zoen-plan tests/chaos/spec-019/restore-suppression.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/chaos/spec-019/restore-suppression.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/chaos/spec-019/restore-suppression.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
// Specs: [SPEC-019](../../../docs/specs/spec-019.md).
// Tickets: [ZN-0116](../../../docs/tickets/zn-0116.md).
//
