...
import { ImportDocument } from "@zoen/contracts/d01/evidence";
      ...
      (database) =>
        withStorage(({ client, config }) =>
          Effect.gen(function* upgradeHistory() {
            ...
            ).toStrictEqual([{ document_format: "d01.json.v1" }]);
            const [row] =
            ...
            expect(
              ...
              [
                { capture_id: seed.capture, document_format: "d01.json.v1" },
                { capture_id: csvCapture, document_format: "d01.csv.v1" },
