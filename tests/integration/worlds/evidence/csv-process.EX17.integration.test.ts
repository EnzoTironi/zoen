...
it.live(
  "CSV-11 SIGKILL before SQL commit rolls back state/receipt/outbox; lost acknowledgement after commit replays once through a restarted real executor",
  () =>
