...
Update 2026-09-06 (ID-08 writers): independent SIGKILL + concurrency counterproofs for ResolveIdentity landed.

Update 2026-09-06 (recovery limits): unit oracle `recovery-question-limits.EX27.test.ts` closes prospective Question byte/entry/depth + claim-invariance; writers enforce via `ensureQuestionFits`.
