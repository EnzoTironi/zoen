// @zoen-plan tests/component/spec-020/watch-contract.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-020/watch-contract.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-020/watch-contract.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0118 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0118-AC:
//     ARRANGE The same watch creation request is retried and later paused
//     ACT Source updates continue
//     ASSERT Only one Watch exists and paused state emits no Notices while retaining an explainable checkpoint policy
