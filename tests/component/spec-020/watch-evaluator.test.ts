// @zoen-plan tests/component/spec-020/watch-evaluator.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-020/watch-evaluator.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-020/watch-evaluator.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0119 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0119-AC:
//     ARRANGE A supplier delivery moves by an immaterial amount, then crosses a critical deadline; later the source becomes stale
//     ACT Evaluation consumes the transitions twice
//     ASSERT The noise is silent; each material/stale transition creates one canonical Notice with its basis
