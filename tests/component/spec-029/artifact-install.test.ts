// @zoen-plan tests/component/spec-029/artifact-install.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-029/artifact-install.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-029/artifact-install.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0171 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0171-AC:
//     ARRANGE An agent proposes installation requesting all-source and all-action access
//     ACT Installation is evaluated
//     ASSERT Requested capabilities do not become grants; unauthorized expansion is denied and permitted narrow installation is explicit
