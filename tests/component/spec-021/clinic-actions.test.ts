// @zoen-plan tests/component/spec-021/clinic-actions.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-021/clinic-actions.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-021/clinic-actions.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0126 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0126-AC:
//     ARRANGE Two proposed reschedules target the same provider and room interval; S4 action execution is not yet admitted
//     ACT The compiler and evaluation harness validate the clinic pack
//     ASSERT Both definitions require the shared interval guard and current source coverage; production rescheduling stays disabled until the S4 concurrent-commit proof passes
