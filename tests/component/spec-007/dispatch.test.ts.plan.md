// @zoen-plan tests/component/spec-007/dispatch.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-007/dispatch.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-007/dispatch.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
