// @zoen-plan tests/component/spec-026/mcp.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-026/mcp.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-026/mcp.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0156 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0156-AC:
//     ARRANGE A malicious MCP client invokes an undiscovered privileged tool by name
//     ACT The server processes the call
//     ASSERT The same authorization/schema path denies it; undiscovered capability names do not provide a bypass
