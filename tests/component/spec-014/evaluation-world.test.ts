// @zoen-plan tests/component/spec-014/evaluation-world.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-014/evaluation-world.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-014/evaluation-world.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
// Specs: [SPEC-014](../../../docs/specs/spec-014.md).
// Tickets: [ZN-0083](../../../docs/tickets/zn-0083.md).
//
