// @zoen-plan tests/component/spec-014/change-lanes.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-014/change-lanes.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-014/change-lanes.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0082 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0082-AC:
//     ARRANGE An agent labels a rights expansion as a tone preference
//     ACT The semantic diff classifies the candidate
//     ASSERT It enters the rights-change lane and cannot use the candidate policy to grant or approve itself
