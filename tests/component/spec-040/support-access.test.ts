// @zoen-plan tests/component/spec-040/support-access.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-040/support-access.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-040/support-access.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0233 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0233-AC:
//     ARRANGE An operator tries to inspect a customer’s clinical note using general incident access
//     ACT The support gateway evaluates the request
//     ASSERT Access is denied without the specific approved scope; all attempted/allowed support actions are auditable
