// @zoen-plan tests/component/spec-047/custody-settlement.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-047/custody-settlement.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-047/custody-settlement.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0277 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0277-AC:
//     ARRANGE An order is filled and allocated but the custodian reports a settlement fail
//     ACT Portfolio and user status refresh
//     ASSERT Filled/allocated state persists while actual settlement remains failed/pending; the product does not report custody complete
