// @zoen-plan tests/component/spec-009/tool-dispatch.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-009/tool-dispatch.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-009/tool-dispatch.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0054 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0054-AC:
//     ARRANGE A tool succeeds but Eve crashes before recording its result
//     ACT The turn resumes and repeats the tool call
//     ASSERT Ontology returns the same authorized result; no duplicate mutation or effect is created
