// @zoen-plan tests/component/spec-042/epoch-promotion.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-042/epoch-promotion.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-042/epoch-promotion.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0248 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0248-AC:
//     ARRANGE Two destination candidates race promotion from the same source epoch
//     ACT Both request activation
//     ASSERT Only one wins; all old-epoch writes/permits fail and no global superuser bypass exists
