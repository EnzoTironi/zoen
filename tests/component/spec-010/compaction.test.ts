// @zoen-plan tests/component/spec-010/compaction.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-010/compaction.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-010/compaction.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0059 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0059-AC:
//     ARRANGE A prior summary says a bill was paid, but the source only contains an unverified human assertion
//     ACT A later answer is composed
//     ASSERT The summary cannot upgrade payment verification or bypass evidence checks
