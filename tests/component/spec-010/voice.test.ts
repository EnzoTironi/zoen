// @zoen-plan tests/component/spec-010/voice.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-010/voice.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-010/voice.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
