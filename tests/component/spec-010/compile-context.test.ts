// @zoen-plan tests/component/spec-010/compile-context.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-010/compile-context.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-010/compile-context.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
