// @zoen-plan tests/component/spec-013/capability-definitions.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-013/capability-definitions.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-013/capability-definitions.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0077 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0077-AC:
//     ARRANGE A user adds a source mapping and an agent proposes a skill requesting wider access
//     ACT The compiler creates candidate plans
//     ASSERT The mapping compiles without app code change; the skill declares but does not obtain new authority
