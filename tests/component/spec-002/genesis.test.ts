// @zoen-plan tests/component/spec-002/genesis.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-002/genesis.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-002/genesis.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0014 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0014-AC:
//     ARRANGE Two concurrent create requests by the same principal with the same operation ID
//     ACT Both commit through actual PostgreSQL
//     ASSERT Exactly one World and one receipt exist; retries return its authorized reference
