// @zoen-plan tests/component/spec-023/effect-cancel.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-023/effect-cancel.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-023/effect-cancel.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
