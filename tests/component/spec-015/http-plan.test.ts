// @zoen-plan tests/component/spec-015/http-plan.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-015/http-plan.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-015/http-plan.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0091 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0091-AC:
//     ARRANGE A source response contains a next-page URL targeting metadata or another host
//     ACT The worker follows pagination
//     ASSERT The request is rejected before credential/network use outside the allowed scope; valid pages retain exact provenance
