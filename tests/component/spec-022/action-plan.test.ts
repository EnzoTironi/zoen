// @zoen-plan tests/component/spec-022/action-plan.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/component/spec-022/action-plan.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/component/spec-022/action-plan.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0129 [required layer=component; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0129-AC:
//     ARRANGE A supplier purchase proposes recipient A, amount 50.00 and an expiry
//     ACT The client changes recipient or amount after preview
//     ASSERT The saved Case digest no longer matches; the original approval cannot authorize the altered operation
