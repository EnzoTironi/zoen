// @zoen-plan tests/journey/spec-020/attention-journey.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/journey/spec-020/attention-journey.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/journey/spec-020/attention-journey.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
// Specs: [SPEC-020](../../../docs/specs/spec-020.md).
// Tickets: [ZN-0123](../../../docs/tickets/zn-0123.md).
//
// ## Responsibility and reuse
//
// ```text
// SUITE ZN-0123 [required layer=journey; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0123-AC:
//     ARRANGE A supplier delay threatens a bakery order and many nonmaterial observations follow
//     ACT The end-to-end attention suite runs
//     ASSERT One meaningful Notice is produced; channel behavior is honest and no raw-observation-to-model fanout appears
