// @zoen-plan tests/journey/spec-012/onboarding.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/journey/spec-012/onboarding.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/journey/spec-012/onboarding.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
