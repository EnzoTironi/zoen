// @zoen-plan tests/journey/spec-012/shared-device.test.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tests/journey/spec-012/shared-device.test.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tests/journey/spec-012/shared-device.test.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// SUITE ZN-0073 [required layer=journey; currently NOT IMPLEMENTED]
//   REQUIRE real admitted dependencies and disposable owned namespaces; missing dependency => BLOCKED.
//   USE synthetic input records, not synthetic services, fake credentials or canned provider responses.
//
//   TEST ZN-0073-AC:
//     ARRANGE User B takes over a browser previously used by user A
//     ACT The browser back button and cached deep link are used
//     ASSERT A’s private content is not rendered from cache before authorization; B sees only permitted data
