# File plan — `tests/fixtures/spec-015/inventory.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-015/inventory.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
