# File plan — `tests/fixtures/spec-015/checkpoints.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-015/checkpoints.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
