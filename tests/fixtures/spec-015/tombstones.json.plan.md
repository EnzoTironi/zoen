# File plan — `tests/fixtures/spec-015/tombstones.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-015/tombstones.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
