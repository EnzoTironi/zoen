# File plan — `tests/fixtures/spec-015/oauth-binding.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-015/oauth-binding.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
