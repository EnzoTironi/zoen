# File plan — `tests/fixtures/spec-015/http-plan.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-015/http-plan.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
