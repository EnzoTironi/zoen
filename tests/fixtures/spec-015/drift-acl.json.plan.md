# File plan — `tests/fixtures/spec-015/drift-acl.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-015/drift-acl.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
