# File plan — `tests/fixtures/spec-016/foundation-pack.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-016/foundation-pack.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
