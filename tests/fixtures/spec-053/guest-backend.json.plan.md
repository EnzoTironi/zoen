# File plan — `tests/fixtures/spec-053/guest-backend.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-053/guest-backend.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
