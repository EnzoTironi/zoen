# File plan — `tests/fixtures/spec-053/app-origins.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-053/app-origins.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
