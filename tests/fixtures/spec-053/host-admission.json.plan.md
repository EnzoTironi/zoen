# File plan — `tests/fixtures/spec-053/host-admission.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-053/host-admission.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
