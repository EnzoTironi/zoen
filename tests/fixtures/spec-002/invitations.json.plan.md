# File plan — `tests/fixtures/spec-002/invitations.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `tests/fixtures/spec-002/invitations.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
