# File plan — `tests/fixtures/spec-002/presence.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-002/presence.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
