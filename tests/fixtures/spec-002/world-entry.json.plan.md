# File plan — `tests/fixtures/spec-002/world-entry.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `tests/fixtures/spec-002/world-entry.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
