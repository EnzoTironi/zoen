# File plan — `tests/fixtures/spec-002/entry-isolation.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `tests/fixtures/spec-002/entry-isolation.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
