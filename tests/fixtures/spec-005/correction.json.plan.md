# File plan — `tests/fixtures/spec-005/correction.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-005/correction.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
