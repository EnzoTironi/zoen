# File plan — `tests/fixtures/spec-005/interpret.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-005/interpret.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
