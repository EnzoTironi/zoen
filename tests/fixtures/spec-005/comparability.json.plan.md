# File plan — `tests/fixtures/spec-005/comparability.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-005/comparability.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
