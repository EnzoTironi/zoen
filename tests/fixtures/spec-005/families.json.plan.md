# File plan — `tests/fixtures/spec-005/families.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-005/families.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
