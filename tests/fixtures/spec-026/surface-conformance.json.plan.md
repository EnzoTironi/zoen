# File plan — `tests/fixtures/spec-026/surface-conformance.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-026/surface-conformance.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
