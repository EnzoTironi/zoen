# File plan — `tests/fixtures/spec-026/cli-generation.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-026/cli-generation.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
