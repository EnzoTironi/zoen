# File plan — `tests/fixtures/spec-026/rest-openapi.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-026/rest-openapi.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
