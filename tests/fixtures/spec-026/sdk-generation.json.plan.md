# File plan — `tests/fixtures/spec-026/sdk-generation.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-026/sdk-generation.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
