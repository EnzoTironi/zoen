# File plan — `tests/fixtures/spec-030/runner-limits.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-030/runner-limits.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
