# File plan — `tests/fixtures/spec-030/runner-profile.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-030/runner-profile.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
