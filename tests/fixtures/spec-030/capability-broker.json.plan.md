# File plan — `tests/fixtures/spec-030/capability-broker.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-030/capability-broker.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
