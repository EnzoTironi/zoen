# File plan — `tests/fixtures/spec-030/runner-output.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-030/runner-output.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
