# File plan — `tests/fixtures/spec-030/runner-security-proof.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-030/runner-security-proof.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
