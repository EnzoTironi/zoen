# File plan — `tests/fixtures/spec-020/watch-contract.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-020/watch-contract.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
