# File plan — `tests/fixtures/spec-020/attention-policy.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-020/attention-policy.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
