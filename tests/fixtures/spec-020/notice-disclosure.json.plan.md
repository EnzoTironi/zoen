# File plan — `tests/fixtures/spec-020/notice-disclosure.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-020/notice-disclosure.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
