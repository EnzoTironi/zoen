# File plan — `tests/fixtures/spec-020/watch-inspector.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-020/watch-inspector.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
