# File plan — `tests/fixtures/spec-024/domain-agency.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-024/domain-agency.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
