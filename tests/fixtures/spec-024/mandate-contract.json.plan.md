# File plan — `tests/fixtures/spec-024/mandate-contract.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-024/mandate-contract.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
