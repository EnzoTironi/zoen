# File plan — `tests/fixtures/spec-024/outcome-observation.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-024/outcome-observation.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
