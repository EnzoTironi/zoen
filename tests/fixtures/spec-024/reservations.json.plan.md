# File plan — `tests/fixtures/spec-024/reservations.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-024/reservations.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
