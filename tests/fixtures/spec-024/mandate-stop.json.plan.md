# File plan — `tests/fixtures/spec-024/mandate-stop.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-024/mandate-stop.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
