# File plan — `tests/fixtures/spec-019/erasure-execute.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-019/erasure-execute.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
