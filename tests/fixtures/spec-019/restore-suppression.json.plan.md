# File plan — `tests/fixtures/spec-019/restore-suppression.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-019/restore-suppression.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
