# File plan — `tests/fixtures/spec-019/legal-hold.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-019/legal-hold.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
