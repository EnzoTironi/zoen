# File plan — `tests/fixtures/spec-019/retention-policy.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-019/retention-policy.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
