# File plan — `tests/fixtures/spec-019/erasure-plan.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-019/erasure-plan.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
