# File plan — `tests/fixtures/spec-019/lifecycle-journey.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-019/lifecycle-journey.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
