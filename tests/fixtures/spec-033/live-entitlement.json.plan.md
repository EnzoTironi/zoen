# File plan — `tests/fixtures/spec-033/live-entitlement.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-033/live-entitlement.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
