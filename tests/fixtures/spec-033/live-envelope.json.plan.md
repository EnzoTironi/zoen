# File plan — `tests/fixtures/spec-033/live-envelope.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-033/live-envelope.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
