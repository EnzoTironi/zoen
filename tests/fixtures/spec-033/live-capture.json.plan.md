# File plan — `tests/fixtures/spec-033/live-capture.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-033/live-capture.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
