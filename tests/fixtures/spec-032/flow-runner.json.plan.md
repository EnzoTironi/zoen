# File plan — `tests/fixtures/spec-032/flow-runner.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-032/flow-runner.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
