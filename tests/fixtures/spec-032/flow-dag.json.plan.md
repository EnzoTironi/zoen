# File plan — `tests/fixtures/spec-032/flow-dag.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-032/flow-dag.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
