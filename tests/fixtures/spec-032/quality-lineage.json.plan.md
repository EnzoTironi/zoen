# File plan — `tests/fixtures/spec-032/quality-lineage.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-032/quality-lineage.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
