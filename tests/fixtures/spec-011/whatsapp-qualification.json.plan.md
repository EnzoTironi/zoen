# File plan — `tests/fixtures/spec-011/whatsapp-qualification.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-011/whatsapp-qualification.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
