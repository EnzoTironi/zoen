# File plan — `tests/fixtures/spec-011/channel-binding.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-011/channel-binding.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
