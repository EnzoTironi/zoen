# File plan — `tests/fixtures/spec-011/send-policy.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-011/send-policy.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
