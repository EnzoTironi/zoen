# File plan — `tests/fixtures/spec-031/dataset-read.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-031/dataset-read.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
