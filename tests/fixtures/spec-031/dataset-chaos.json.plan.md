# File plan — `tests/fixtures/spec-031/dataset-chaos.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-031/dataset-chaos.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
