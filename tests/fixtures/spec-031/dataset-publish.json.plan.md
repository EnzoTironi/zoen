# File plan — `tests/fixtures/spec-031/dataset-publish.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-031/dataset-publish.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
