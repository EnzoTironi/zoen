# File plan — `tests/fixtures/spec-031/dense-profile.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-031/dense-profile.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
