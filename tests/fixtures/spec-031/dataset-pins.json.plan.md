# File plan — `tests/fixtures/spec-031/dataset-pins.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-031/dataset-pins.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
