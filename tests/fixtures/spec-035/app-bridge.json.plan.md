# File plan — `tests/fixtures/spec-035/app-bridge.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-035/app-bridge.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
