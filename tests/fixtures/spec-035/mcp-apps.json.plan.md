# File plan — `tests/fixtures/spec-035/mcp-apps.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-035/mcp-apps.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
