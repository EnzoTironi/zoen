# File plan — `tests/fixtures/spec-035/studio-editors.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-035/studio-editors.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
