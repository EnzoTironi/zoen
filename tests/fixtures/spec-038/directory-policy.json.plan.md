# File plan — `tests/fixtures/spec-038/directory-policy.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-038/directory-policy.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
