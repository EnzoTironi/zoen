# File plan — `tests/fixtures/spec-038/enterprise-sso.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-038/enterprise-sso.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
