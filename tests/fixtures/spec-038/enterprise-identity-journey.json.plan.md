# File plan — `tests/fixtures/spec-038/enterprise-identity-journey.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-038/enterprise-identity-journey.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
