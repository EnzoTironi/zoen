# File plan — `tests/fixtures/spec-038/workload-identity.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-038/workload-identity.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
