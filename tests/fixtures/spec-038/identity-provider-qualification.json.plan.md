# File plan — `tests/fixtures/spec-038/identity-provider-qualification.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-038/identity-provider-qualification.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
