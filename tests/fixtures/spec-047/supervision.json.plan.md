# File plan — `tests/fixtures/spec-047/supervision.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-047/supervision.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
