# File plan — `tests/fixtures/spec-047/order-lifecycle.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-047/order-lifecycle.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
