# File plan — `tests/fixtures/spec-047/cancel-replace.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-047/cancel-replace.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
