# File plan — `tests/fixtures/spec-047/finance-lifecycle-journey.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-047/finance-lifecycle-journey.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
