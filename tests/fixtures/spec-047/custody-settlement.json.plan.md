# File plan — `tests/fixtures/spec-047/custody-settlement.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-047/custody-settlement.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
