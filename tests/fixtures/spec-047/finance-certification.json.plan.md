# File plan — `tests/fixtures/spec-047/finance-certification.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-047/finance-certification.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
