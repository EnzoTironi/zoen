# File plan — `tests/fixtures/spec-047/executions.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-047/executions.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
