# File plan — `tests/fixtures/spec-050/streaming-path.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-050/streaming-path.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
