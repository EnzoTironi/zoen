# File plan — `tests/fixtures/spec-050/bounded-reads.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-050/bounded-reads.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
