# File plan — `tests/fixtures/spec-050/executor-binding.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `tests/fixtures/spec-050/executor-binding.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
