# File plan — `tests/fixtures/spec-023/effect-cancel.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-023/effect-cancel.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
