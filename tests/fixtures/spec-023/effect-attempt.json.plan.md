# File plan — `tests/fixtures/spec-023/effect-attempt.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-023/effect-attempt.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
