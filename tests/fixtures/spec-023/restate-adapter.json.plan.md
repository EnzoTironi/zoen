# File plan — `tests/fixtures/spec-023/restate-adapter.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-023/restate-adapter.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
