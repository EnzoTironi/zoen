# File plan — `tests/fixtures/spec-023/provider-effect-qualification.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-023/provider-effect-qualification.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
