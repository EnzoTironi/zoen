# File plan — `tests/fixtures/spec-023/effect-reconcile.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-023/effect-reconcile.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
