# File plan — `tests/fixtures/spec-023/effect-permits.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-023/effect-permits.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
