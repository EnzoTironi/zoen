# File plan — `tests/fixtures/spec-052/app-definition.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-052/app-definition.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
