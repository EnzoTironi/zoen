# File plan — `tests/fixtures/spec-052/app-actions.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-052/app-actions.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
