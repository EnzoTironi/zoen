# File plan — `tests/fixtures/spec-052/app-publication.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-052/app-publication.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
