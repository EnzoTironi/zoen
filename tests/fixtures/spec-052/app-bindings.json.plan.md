# File plan — `tests/fixtures/spec-052/app-bindings.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-052/app-bindings.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
