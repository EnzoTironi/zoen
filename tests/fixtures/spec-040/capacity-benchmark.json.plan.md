# File plan — `tests/fixtures/spec-040/capacity-benchmark.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-040/capacity-benchmark.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
