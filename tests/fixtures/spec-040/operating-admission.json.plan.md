# File plan — `tests/fixtures/spec-040/operating-admission.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-040/operating-admission.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
