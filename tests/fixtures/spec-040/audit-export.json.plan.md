# File plan — `tests/fixtures/spec-040/audit-export.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-040/audit-export.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
