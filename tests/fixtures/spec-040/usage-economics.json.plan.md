# File plan — `tests/fixtures/spec-040/usage-economics.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-040/usage-economics.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
