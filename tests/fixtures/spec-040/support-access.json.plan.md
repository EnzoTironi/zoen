# File plan — `tests/fixtures/spec-040/support-access.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-040/support-access.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
