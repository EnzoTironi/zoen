# File plan — `tests/fixtures/spec-006/identity-case.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-006/identity-case.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
