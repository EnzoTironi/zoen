# File plan — `tests/fixtures/spec-049/capability-admission.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-049/capability-admission.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
