# File plan — `tests/fixtures/spec-049/pilot-readiness.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-049/pilot-readiness.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
