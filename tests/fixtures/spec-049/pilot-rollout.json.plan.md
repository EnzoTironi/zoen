# File plan — `tests/fixtures/spec-049/pilot-rollout.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-049/pilot-rollout.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
