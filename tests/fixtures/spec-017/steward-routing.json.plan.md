# File plan — `tests/fixtures/spec-017/steward-routing.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-017/steward-routing.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
