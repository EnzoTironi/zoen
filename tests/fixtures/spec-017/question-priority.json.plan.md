# File plan — `tests/fixtures/spec-017/question-priority.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-017/question-priority.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
