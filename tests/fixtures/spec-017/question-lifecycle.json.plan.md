# File plan — `tests/fixtures/spec-017/question-lifecycle.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-017/question-lifecycle.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
