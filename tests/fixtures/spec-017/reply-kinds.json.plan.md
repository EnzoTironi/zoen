# File plan — `tests/fixtures/spec-017/reply-kinds.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-017/reply-kinds.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
