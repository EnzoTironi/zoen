# File plan — `tests/fixtures/spec-004/capture-gc.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-004/capture-gc.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
