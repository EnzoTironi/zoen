# File plan — `tests/fixtures/spec-004/evidence-read.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-004/evidence-read.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
