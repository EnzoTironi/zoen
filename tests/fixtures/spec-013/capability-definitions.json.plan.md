# File plan — `tests/fixtures/spec-013/capability-definitions.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-013/capability-definitions.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
