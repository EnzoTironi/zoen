# File plan — `tests/fixtures/spec-013/semantic-diff.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-013/semantic-diff.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
