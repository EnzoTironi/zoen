# File plan — `tests/fixtures/spec-013/ontology-grammar.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-013/ontology-grammar.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
