# File plan — `tests/fixtures/spec-013/compiler-laws.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-013/compiler-laws.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
