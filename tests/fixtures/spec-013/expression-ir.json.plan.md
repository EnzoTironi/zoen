# File plan — `tests/fixtures/spec-013/expression-ir.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-013/expression-ir.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
