# File plan — `tests/fixtures/spec-013/standards.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-013/standards.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
