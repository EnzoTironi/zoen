# File plan — `tests/fixtures/spec-028/channel-capabilities.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-028/channel-capabilities.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
