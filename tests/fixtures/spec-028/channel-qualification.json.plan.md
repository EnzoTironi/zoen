# File plan — `tests/fixtures/spec-028/channel-qualification.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-028/channel-qualification.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
