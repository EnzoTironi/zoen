# File plan — `tests/fixtures/spec-028/telegram.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-028/telegram.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
