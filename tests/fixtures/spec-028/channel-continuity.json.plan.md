# File plan — `tests/fixtures/spec-028/channel-continuity.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-028/channel-continuity.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
