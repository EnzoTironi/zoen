# File plan — `tests/fixtures/spec-042/epoch-promotion.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-042/epoch-promotion.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
