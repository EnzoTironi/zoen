# File plan — `tests/fixtures/spec-042/migration-chaos.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-042/migration-chaos.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
