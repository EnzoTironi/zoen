# File plan — `tests/fixtures/spec-042/cell-directory.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-042/cell-directory.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
