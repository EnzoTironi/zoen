# File plan — `tests/fixtures/spec-042/source-fence.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-042/source-fence.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
