# File plan — `tests/fixtures/spec-007/dispatch.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-007/dispatch.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
