# File plan — `tests/fixtures/spec-007/frame-basis.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-007/frame-basis.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
