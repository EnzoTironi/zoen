# File plan — `tests/fixtures/spec-007/discovery.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-007/discovery.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
