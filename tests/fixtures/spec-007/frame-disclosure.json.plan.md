# File plan — `tests/fixtures/spec-007/frame-disclosure.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-007/frame-disclosure.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
