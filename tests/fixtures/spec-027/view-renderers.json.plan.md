# File plan — `tests/fixtures/spec-027/view-renderers.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-027/view-renderers.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
