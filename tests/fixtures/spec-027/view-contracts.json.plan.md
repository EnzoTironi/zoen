# File plan — `tests/fixtures/spec-027/view-contracts.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-027/view-contracts.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
