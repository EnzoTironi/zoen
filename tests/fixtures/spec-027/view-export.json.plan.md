# File plan — `tests/fixtures/spec-027/view-export.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-027/view-export.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
