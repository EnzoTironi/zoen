# File plan — `tests/fixtures/spec-036/model-registry.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-036/model-registry.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
