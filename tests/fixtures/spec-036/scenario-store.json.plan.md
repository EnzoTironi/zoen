# File plan — `tests/fixtures/spec-036/scenario-store.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-036/scenario-store.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
