# File plan — `tests/fixtures/spec-036/scenario-compare.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-036/scenario-compare.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
