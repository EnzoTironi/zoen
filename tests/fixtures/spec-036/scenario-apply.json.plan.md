# File plan — `tests/fixtures/spec-036/scenario-apply.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-036/scenario-apply.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
