# File plan — `tests/fixtures/spec-036/training-manifest.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-036/training-manifest.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
