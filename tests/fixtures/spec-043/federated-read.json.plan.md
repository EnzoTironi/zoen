# File plan — `tests/fixtures/spec-043/federated-read.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-043/federated-read.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
