# File plan — `tests/fixtures/spec-043/federation-journey.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-043/federation-journey.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
