# File plan — `tests/fixtures/spec-043/coordination.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-043/coordination.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
