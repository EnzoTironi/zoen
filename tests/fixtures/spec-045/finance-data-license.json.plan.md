# File plan — `tests/fixtures/spec-045/finance-data-license.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-045/finance-data-license.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
