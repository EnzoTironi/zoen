# File plan — `tests/fixtures/spec-045/financial-news.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-045/financial-news.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
