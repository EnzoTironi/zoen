# File plan — `tests/fixtures/spec-045/finance-data-journey.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-045/finance-data-journey.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
