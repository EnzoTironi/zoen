# File plan — `tests/fixtures/spec-045/fundamentals.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-045/fundamentals.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
