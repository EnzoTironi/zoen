# File plan — `tests/fixtures/spec-045/corporate-actions.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-045/corporate-actions.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
