# File plan — `tests/fixtures/spec-001/temporal.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-001/temporal.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
