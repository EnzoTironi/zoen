# File plan — `tests/fixtures/spec-001/scalars.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `tests/fixtures/spec-001/scalars.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
