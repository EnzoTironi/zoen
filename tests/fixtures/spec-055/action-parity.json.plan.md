# File plan — `tests/fixtures/spec-055/action-parity.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-055/action-parity.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
