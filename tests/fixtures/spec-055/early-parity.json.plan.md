# File plan — `tests/fixtures/spec-055/early-parity.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-055/early-parity.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
