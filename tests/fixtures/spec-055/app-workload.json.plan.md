# File plan — `tests/fixtures/spec-055/app-workload.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-055/app-workload.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
