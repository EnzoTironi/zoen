# File plan — `tests/fixtures/spec-055/three-audience-apps.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-055/three-audience-apps.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
