# File plan — `tests/fixtures/spec-055/no-bypass-campaign.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-055/no-bypass-campaign.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
