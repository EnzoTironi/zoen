# File plan — `tests/fixtures/spec-046/positions.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-046/positions.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
