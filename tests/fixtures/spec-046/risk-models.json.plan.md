# File plan — `tests/fixtures/spec-046/risk-models.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-046/risk-models.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
