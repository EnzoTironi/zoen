# File plan — `tests/fixtures/spec-046/pretrade-risk.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-046/pretrade-risk.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
