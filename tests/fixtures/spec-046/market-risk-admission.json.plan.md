# File plan — `tests/fixtures/spec-046/market-risk-admission.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-046/market-risk-admission.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
