# File plan — `tests/fixtures/spec-048/adversarial-campaign.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-048/adversarial-campaign.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
