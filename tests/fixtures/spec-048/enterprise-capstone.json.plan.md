# File plan — `tests/fixtures/spec-048/enterprise-capstone.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-048/enterprise-capstone.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
