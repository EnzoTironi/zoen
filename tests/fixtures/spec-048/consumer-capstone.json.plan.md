# File plan — `tests/fixtures/spec-048/consumer-capstone.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-048/consumer-capstone.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
