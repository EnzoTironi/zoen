# File plan — `tests/fixtures/spec-048/final-promotion.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-048/final-promotion.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
