# File plan — `tests/fixtures/spec-021/clinic-scope-review.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-021/clinic-scope-review.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
