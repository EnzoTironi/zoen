# File plan — `tests/fixtures/spec-021/clinic-availability.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-021/clinic-availability.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
