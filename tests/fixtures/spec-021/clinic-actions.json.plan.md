# File plan — `tests/fixtures/spec-021/clinic-actions.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-021/clinic-actions.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
