# File plan — `tests/fixtures/spec-021/clinic-security-journey.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-021/clinic-security-journey.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
