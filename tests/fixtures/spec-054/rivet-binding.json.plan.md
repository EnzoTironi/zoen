# File plan — `tests/fixtures/spec-054/rivet-binding.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-054/rivet-binding.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
