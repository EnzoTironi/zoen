# File plan — `tests/fixtures/spec-054/rivet-host-profile.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-054/rivet-host-profile.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
