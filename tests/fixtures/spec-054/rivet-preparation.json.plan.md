# File plan — `tests/fixtures/spec-054/rivet-preparation.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-054/rivet-preparation.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
