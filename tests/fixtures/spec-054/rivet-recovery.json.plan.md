# File plan — `tests/fixtures/spec-054/rivet-recovery.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-054/rivet-recovery.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
