# File plan — `tests/fixtures/spec-051/browser-exchange.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-051/browser-exchange.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
