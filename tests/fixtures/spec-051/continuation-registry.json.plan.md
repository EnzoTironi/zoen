# File plan — `tests/fixtures/spec-051/continuation-registry.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-051/continuation-registry.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
