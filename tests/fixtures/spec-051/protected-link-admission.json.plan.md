# File plan — `tests/fixtures/spec-051/protected-link-admission.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-051/protected-link-admission.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
