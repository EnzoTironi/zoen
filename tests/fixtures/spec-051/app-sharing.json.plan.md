# File plan — `tests/fixtures/spec-051/app-sharing.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-051/app-sharing.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
