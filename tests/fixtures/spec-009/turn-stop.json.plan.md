# File plan — `tests/fixtures/spec-009/turn-stop.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-009/turn-stop.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
