# File plan — `tests/fixtures/spec-009/turn-chaos.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-009/turn-chaos.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
