# File plan — `tests/fixtures/spec-009/model-attempt.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-009/model-attempt.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
