# File plan — `tests/fixtures/spec-009/turn-store.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-009/turn-store.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
