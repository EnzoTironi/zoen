# File plan — `tests/fixtures/spec-034/compute-qualification.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-034/compute-qualification.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
