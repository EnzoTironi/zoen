# File plan — `tests/fixtures/spec-034/virtual-source.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-034/virtual-source.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
