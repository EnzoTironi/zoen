# File plan — `tests/fixtures/spec-034/distributed-contract.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-034/distributed-contract.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
