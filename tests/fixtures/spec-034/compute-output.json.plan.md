# File plan — `tests/fixtures/spec-034/compute-output.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-034/compute-output.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
