# File plan — `tests/fixtures/spec-034/remote-query.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-034/remote-query.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
