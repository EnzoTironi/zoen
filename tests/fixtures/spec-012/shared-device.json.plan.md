# File plan — `tests/fixtures/spec-012/shared-device.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-012/shared-device.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
