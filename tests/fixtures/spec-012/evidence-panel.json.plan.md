# File plan — `tests/fixtures/spec-012/evidence-panel.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-012/evidence-panel.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
