# File plan — `tests/fixtures/spec-012/usability-evidence.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-012/usability-evidence.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
