# File plan — `tests/fixtures/spec-012/onboarding.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-012/onboarding.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
