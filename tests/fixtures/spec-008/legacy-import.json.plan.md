# File plan — `tests/fixtures/spec-008/legacy-import.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-008/legacy-import.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
