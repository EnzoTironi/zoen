# File plan — `tests/fixtures/spec-008/readiness.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-008/readiness.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
