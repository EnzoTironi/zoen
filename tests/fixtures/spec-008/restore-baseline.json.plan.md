# File plan — `tests/fixtures/spec-008/restore-baseline.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-008/restore-baseline.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
