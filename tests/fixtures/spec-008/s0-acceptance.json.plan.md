# File plan — `tests/fixtures/spec-008/s0-acceptance.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-008/s0-acceptance.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
