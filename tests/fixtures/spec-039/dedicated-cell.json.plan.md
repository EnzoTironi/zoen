# File plan — `tests/fixtures/spec-039/dedicated-cell.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-039/dedicated-cell.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
