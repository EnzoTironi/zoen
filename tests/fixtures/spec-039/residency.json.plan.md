# File plan — `tests/fixtures/spec-039/residency.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-039/residency.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
