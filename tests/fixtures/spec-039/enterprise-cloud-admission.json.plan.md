# File plan — `tests/fixtures/spec-039/enterprise-cloud-admission.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-039/enterprise-cloud-admission.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
