# File plan — `tests/fixtures/spec-039/restate-ha.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-039/restate-ha.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
