# File plan — `tests/fixtures/spec-044/offline-reconcile.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-044/offline-reconcile.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
