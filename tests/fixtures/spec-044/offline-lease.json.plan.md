# File plan — `tests/fixtures/spec-044/offline-lease.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-044/offline-lease.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
