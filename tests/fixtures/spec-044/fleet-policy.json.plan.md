# File plan — `tests/fixtures/spec-044/fleet-policy.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-044/fleet-policy.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
