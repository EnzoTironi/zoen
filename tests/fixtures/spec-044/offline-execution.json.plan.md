# File plan — `tests/fixtures/spec-044/offline-execution.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-044/offline-execution.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
