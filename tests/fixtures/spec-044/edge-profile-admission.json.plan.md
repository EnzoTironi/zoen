# File plan — `tests/fixtures/spec-044/edge-profile-admission.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-044/edge-profile-admission.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
