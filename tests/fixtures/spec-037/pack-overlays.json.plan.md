# File plan — `tests/fixtures/spec-037/pack-overlays.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-037/pack-overlays.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
