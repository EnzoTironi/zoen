# File plan — `tests/fixtures/spec-037/marketplace-gate.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-037/marketplace-gate.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
