# File plan — `tests/fixtures/spec-037/pack-upgrade.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-037/pack-upgrade.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
