# File plan — `tests/fixtures/spec-037/publisher-governance.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-037/publisher-governance.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
