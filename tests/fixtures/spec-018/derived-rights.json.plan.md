# File plan — `tests/fixtures/spec-018/derived-rights.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-018/derived-rights.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
