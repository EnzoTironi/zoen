# File plan — `tests/fixtures/spec-018/audience-view.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-018/audience-view.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
