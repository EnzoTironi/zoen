# File plan — `tests/fixtures/spec-018/rights-noninterference.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-018/rights-noninterference.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
