# File plan — `tests/fixtures/spec-018/delegation.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-018/delegation.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
