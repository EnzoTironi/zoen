# File plan — `tests/fixtures/spec-018/cedar-admission.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-018/cedar-admission.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
