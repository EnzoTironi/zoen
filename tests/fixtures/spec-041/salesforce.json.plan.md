# File plan — `tests/fixtures/spec-041/salesforce.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-041/salesforce.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
