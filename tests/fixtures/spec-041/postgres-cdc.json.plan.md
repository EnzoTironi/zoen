# File plan — `tests/fixtures/spec-041/postgres-cdc.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-041/postgres-cdc.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
