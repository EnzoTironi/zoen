# File plan — `tests/fixtures/spec-041/enterprise-source-qualification.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-041/enterprise-source-qualification.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
