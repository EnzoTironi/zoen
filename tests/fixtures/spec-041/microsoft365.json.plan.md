# File plan — `tests/fixtures/spec-041/microsoft365.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-041/microsoft365.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
