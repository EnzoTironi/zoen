# File plan — `tests/fixtures/spec-041/warehouse.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-041/warehouse.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
