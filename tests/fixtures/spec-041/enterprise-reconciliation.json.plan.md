# File plan — `tests/fixtures/spec-041/enterprise-reconciliation.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-041/enterprise-reconciliation.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
