# File plan — `tests/fixtures/spec-014/activate.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-014/activate.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
