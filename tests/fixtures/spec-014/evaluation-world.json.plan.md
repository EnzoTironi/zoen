# File plan — `tests/fixtures/spec-014/evaluation-world.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-014/evaluation-world.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
