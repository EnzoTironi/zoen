# File plan — `tests/fixtures/spec-014/change-lanes.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-014/change-lanes.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
