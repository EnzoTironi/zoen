# File plan — `tests/fixtures/spec-025/injection-containment.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-025/injection-containment.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
