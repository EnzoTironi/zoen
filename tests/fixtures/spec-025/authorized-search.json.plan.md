# File plan — `tests/fixtures/spec-025/authorized-search.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-025/authorized-search.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
