# File plan — `tests/fixtures/spec-025/search-projection.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-025/search-projection.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
