# File plan — `tests/fixtures/spec-025/search-frame.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-025/search-frame.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
