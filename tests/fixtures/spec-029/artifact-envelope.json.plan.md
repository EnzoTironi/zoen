# File plan — `tests/fixtures/spec-029/artifact-envelope.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-029/artifact-envelope.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
