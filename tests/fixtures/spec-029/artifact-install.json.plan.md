# File plan — `tests/fixtures/spec-029/artifact-install.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-029/artifact-install.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
