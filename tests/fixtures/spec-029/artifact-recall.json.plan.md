# File plan — `tests/fixtures/spec-029/artifact-recall.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-029/artifact-recall.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
