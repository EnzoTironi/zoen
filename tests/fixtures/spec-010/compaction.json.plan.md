# File plan — `tests/fixtures/spec-010/compaction.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-010/compaction.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
