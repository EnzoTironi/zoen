# File plan — `tests/fixtures/spec-010/composition.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-010/composition.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
