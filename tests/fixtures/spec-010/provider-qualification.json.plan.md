# File plan — `tests/fixtures/spec-010/provider-qualification.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-010/provider-qualification.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
