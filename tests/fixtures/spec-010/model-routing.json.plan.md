# File plan — `tests/fixtures/spec-010/model-routing.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-010/model-routing.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
