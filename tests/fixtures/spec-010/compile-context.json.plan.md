# File plan — `tests/fixtures/spec-010/compile-context.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-010/compile-context.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
