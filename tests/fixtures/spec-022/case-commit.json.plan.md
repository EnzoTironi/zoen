# File plan — `tests/fixtures/spec-022/case-commit.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-022/case-commit.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
