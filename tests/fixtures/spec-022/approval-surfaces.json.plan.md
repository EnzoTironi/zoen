# File plan — `tests/fixtures/spec-022/approval-surfaces.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-022/approval-surfaces.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
