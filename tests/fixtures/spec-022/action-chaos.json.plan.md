# File plan — `tests/fixtures/spec-022/action-chaos.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-022/action-chaos.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
