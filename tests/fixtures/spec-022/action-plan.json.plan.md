# File plan — `tests/fixtures/spec-022/action-plan.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-022/action-plan.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
