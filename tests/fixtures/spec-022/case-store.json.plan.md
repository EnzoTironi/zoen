# File plan — `tests/fixtures/spec-022/case-store.json`

**Status:** planned; no product acceptance implied.

Target: `tests/fixtures/spec-022/case-store.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
