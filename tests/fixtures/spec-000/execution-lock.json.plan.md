# File plan — `tests/fixtures/spec-000/execution-lock.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `tests/fixtures/spec-000/execution-lock.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
