# File plan — `tests/fixtures/spec-000/supply-chain.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `tests/fixtures/spec-000/supply-chain.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
