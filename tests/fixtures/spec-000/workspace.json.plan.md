# File plan — `tests/fixtures/spec-000/workspace.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `tests/fixtures/spec-000/workspace.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
