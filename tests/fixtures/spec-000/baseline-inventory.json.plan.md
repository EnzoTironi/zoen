# File plan — `tests/fixtures/spec-000/baseline-inventory.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `tests/fixtures/spec-000/baseline-inventory.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
