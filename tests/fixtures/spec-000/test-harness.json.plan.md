# File plan — `tests/fixtures/spec-000/test-harness.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `tests/fixtures/spec-000/test-harness.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
