# File plan — `tests/real/vertical-slice.test.mjs`

**Status:** candidate-unaccepted; no product acceptance implied.

Target: `tests/real/vertical-slice.test.mjs`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
