// @zoen-plan tooling/semantic-boundaries/ports.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `tooling/semantic-boundaries/ports.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `tooling/semantic-boundaries/ports.ts`. Representation: **comment-only-source**. Allocation: **conditional-support**.
//
