...
def main():
    ...
    for package in ["packages/contracts", "packages/application-client", "packages/ontology", "packages/oms", "packages/actions", "apps/server", "apps/cli", "apps/mcp", "apps/web"]:
