...
tests/integration/hosted/identity/probe_all_in_one_identity.py (disposable volume;
does not use this application.Dockerfile path or ops/local/provision.ts).
"""
...
def main():
    ...
    environment = {key: value for key, value in os.environ.items() if not key.startswith("ZOEN_")} | {
        ...
        "ZOEN_TEST_SHARING_WEB_URL": origin,
        "ZOEN_TEST_SUBJECT_IDENTITY_WEB_URL": origin,
    }
