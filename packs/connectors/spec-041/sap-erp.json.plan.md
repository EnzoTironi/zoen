# File plan — `packs/connectors/spec-041/sap-erp.json`

**Status:** planned; no product acceptance implied.

Target: `packs/connectors/spec-041/sap-erp.json`. Representation: **sidecar-only**. Allocation: **required**.

Specs: [SPEC-041](../../../docs/specs/spec-041.md).
Tickets: [ZN-0240](../../../docs/tickets/zn-0240.md).
