# File plan — `packs/connectors/spec-041/warehouse.json`

**Status:** planned; no product acceptance implied.

Target: `packs/connectors/spec-041/warehouse.json`. Representation: **sidecar-only**. Allocation: **required**.

Specs: [SPEC-041](../../../docs/specs/spec-041.md).
Tickets: [ZN-0242](../../../docs/tickets/zn-0242.md).
