# File plan — `packs/connectors/spec-041/postgres-cdc.json`

**Status:** planned; no product acceptance implied.

Target: `packs/connectors/spec-041/postgres-cdc.json`. Representation: **sidecar-only**. Allocation: **required**.

Specs: [SPEC-041](../../../docs/specs/spec-041.md).
Tickets: [ZN-0241](../../../docs/tickets/zn-0241.md).
