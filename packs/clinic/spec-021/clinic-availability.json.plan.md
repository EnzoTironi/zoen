# File plan — `packs/clinic/spec-021/clinic-availability.json`

**Status:** planned; no product acceptance implied.

Target: `packs/clinic/spec-021/clinic-availability.json`. Representation: **sidecar-only**. Allocation: **required**.
