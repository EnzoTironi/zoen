# File plan — `packs/finance/analytics/spec-046/market-data-pack.json`

**Status:** planned; no product acceptance implied.

Target: `packs/finance/analytics/spec-046/market-data-pack.json`. Representation: **sidecar-only**. Allocation: **required**.
