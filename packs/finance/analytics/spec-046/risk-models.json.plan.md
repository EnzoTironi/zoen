# File plan — `packs/finance/analytics/spec-046/risk-models.json`

**Status:** planned; no product acceptance implied.

Target: `packs/finance/analytics/spec-046/risk-models.json`. Representation: **sidecar-only**. Allocation: **required**.
