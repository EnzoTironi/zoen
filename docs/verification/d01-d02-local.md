...
A [prova EX15](../../tests/integration/d01-d02-independent/README.md) usa processos distintos, lock PostgreSQL observável e SIGKILL. Antes do COMMIT, nenhuma publicação semântica permanece; após o retorno do executor e antes do acknowledgement do harness, o retry recupera exatamente um receipt. S3 pode conservar captura órfã anterior à publicação. Isso não equivale a uma transação distribuída, crash de PostgreSQL/S3 ou exactly-once de efeito externo.
