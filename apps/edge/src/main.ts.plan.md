# File plan — `apps/edge/src/main.ts`

**Status:** candidate-unaccepted; no product acceptance implied.

Target: `apps/edge/src/main.ts`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.

Specs: [SPEC-007](../../../docs/specs/spec-007.md), [SPEC-049](../../../docs/specs/spec-049.md), [SPEC-050](../../../docs/specs/spec-050.md).
