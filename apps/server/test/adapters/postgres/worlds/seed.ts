...
import { LegacyDomainCut as DomainCut } from "@zoen/authority/ports/worlds/basis";
import { StoredOperationResult } from "@zoen/authority/ports/worlds/persistence";
...
export const seedEvidence = Effect.fn("seedEvidence")(function* seed(
  ...
  yield* sql`INSERT INTO authority.worlds ${sql.insert({
    ...
    data_policy_id: "worlds-local-retained-v1",
