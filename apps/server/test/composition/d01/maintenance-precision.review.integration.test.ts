...
it.live(
  "independent maintenance crosses capture pages at PostgreSQL microsecond precision",
  () =>
      ...
      withStorage(() =>
        Effect.gen(function* backgroundCaptureConsumer() {
          ...
          yield* SqlClient.SqlClient.use(
            (sql) =>
              sql`UPDATE jobs.captures SET expires_at = '2020-01-01T00:00:00.123456Z'::timestamptz`
