// @zoen-plan apps/web/src/living-world/types.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `apps/web/src/living-world/types.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `apps/web/src/living-world/types.ts`. Representation: **comment-only-source**. Allocation: **conditional-support**.
//
