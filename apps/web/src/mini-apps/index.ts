// @zoen-plan apps/web/src/mini-apps/index.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `apps/web/src/mini-apps/index.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `apps/web/src/mini-apps/index.ts`. Representation: **comment-only-source**. Allocation: **conditional-support**.
//
// Specs: [SPEC-035](../../../../docs/specs/spec-035.md), [SPEC-051](../../../../docs/specs/spec-051.md), [SPEC-052](../../../../docs/specs/spec-052.md).
// Tickets: [ZN-0203](../../../../docs/tickets/zn-0203.md), [ZN-0300](../../../../docs/tickets/zn-0300.md), [ZN-0306](../../../../docs/tickets/zn-0306.md).
//
