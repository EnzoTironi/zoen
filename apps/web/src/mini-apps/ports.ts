// @zoen-plan apps/web/src/mini-apps/ports.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `apps/web/src/mini-apps/ports.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `apps/web/src/mini-apps/ports.ts`. Representation: **comment-only-source**. Allocation: **conditional-support**.
//
