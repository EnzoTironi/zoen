...
import { field } from "../../features/d01/form.ts";
import { intervalLabel } from "../../features/d01/presentation.ts";
import type { WorkspaceController } from "../../features/d01/state.ts";
...
export const CorrectionPanel = ({
  ...
  return (
    <section
      ...
      className="d01-workspace d01-context d02-corrections"
    >
