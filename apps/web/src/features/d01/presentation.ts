...
import type { EvidenceOpened } from "@zoen/contracts/d01/operations";
import type { ValidTime } from "@zoen/contracts/d01/values";

import type {
  InspectionView,
  WorkspaceView,
} from "../../components/d01/presentation.ts";
...
export const inspectionView = (
  ...
  return {
    ...
    explanation: frame.contested
      ? "As fontes divergem em um período comparável. Confira os registros e suas origens."
