...
import { importRequest } from "../../../src/features/worlds/requests.ts";
...
it.effect(
  ...
  () =>
    Effect.gen(function* legacyJson() {
      const document = '{"schemaVersion":"worlds.v1","source":"unchanged"}\n';
