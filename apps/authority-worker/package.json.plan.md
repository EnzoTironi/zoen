# File plan — `apps/authority-worker/package.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `apps/authority-worker/package.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
