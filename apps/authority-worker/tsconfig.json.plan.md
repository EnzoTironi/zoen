# File plan — `apps/authority-worker/tsconfig.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `apps/authority-worker/tsconfig.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
