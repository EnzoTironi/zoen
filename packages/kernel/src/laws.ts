// @zoen-plan packages/kernel/src/laws.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/kernel/src/laws.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/kernel/src/laws.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// PROCEDURE ZN_0012 /* planning label, not a public API */
//   OWNER := SPEC-001; TARGET := packages/kernel/src/laws.ts
//   REQUIRE accepted dependencies: ZN-0011
...
//     01. Generate scalar/interval/canonical cases using saved seeds and shrinking.
//     02. Assert conservation, commutativity where defined, idempotent normalization and bounded parser rejection.
//     03. Store minimal counterexamples as regression fixtures rather than mutating the generator to hide them.
//   TEST BEFORE DECLARING THIS SEGMENT COMPLETE:
//     GIVEN At least 10000 deterministic generated cases per named law and adversarial deep payloads
//     WHEN The law suite runs on two locales/timezones
//     THEN Results and canonical digests agree and oversized input fails within configured memory/time limits
