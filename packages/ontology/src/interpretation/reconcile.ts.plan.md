# File plan — `packages/ontology/src/interpretation/reconcile.ts`

**Status:** candidate-unaccepted; no product acceptance implied.

Target: `packages/ontology/src/interpretation/reconcile.ts`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
