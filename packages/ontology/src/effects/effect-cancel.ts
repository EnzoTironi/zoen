// @zoen-plan packages/ontology/src/effects/effect-cancel.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/effects/effect-cancel.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/effects/effect-cancel.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
// Specs: [SPEC-023](../../../../docs/specs/spec-023.md).
// Tickets: [ZN-0139](../../../../docs/tickets/zn-0139.md).
//
