// @zoen-plan packages/ontology/src/effects/effect-permits.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/effects/effect-permits.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/effects/effect-permits.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
// Specs: [SPEC-023](../../../../docs/specs/spec-023.md).
// Tickets: [ZN-0136](../../../../docs/tickets/zn-0136.md).
//
