// @zoen-plan packages/ontology/src/effects/effect-attempt.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/effects/effect-attempt.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/effects/effect-attempt.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
