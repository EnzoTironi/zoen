# File plan — `packages/ontology/src/apps/manifest.ts`

**Status:** candidate-unaccepted; no product acceptance implied.

Target: `packages/ontology/src/apps/manifest.ts`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
