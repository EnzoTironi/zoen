# File plan — `packages/ontology/src/apps/session-constraints.ts`

**Status:** candidate-unaccepted; no product acceptance implied.

Target: `packages/ontology/src/apps/session-constraints.ts`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
