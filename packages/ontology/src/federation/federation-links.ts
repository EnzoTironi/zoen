// @zoen-plan packages/ontology/src/federation/federation-links.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/federation/federation-links.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/federation/federation-links.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
