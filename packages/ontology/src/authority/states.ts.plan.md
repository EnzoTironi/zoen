# File plan — `packages/ontology/src/authority/states.ts`

**Status:** candidate-unaccepted; no product acceptance implied.

Target: `packages/ontology/src/authority/states.ts`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
