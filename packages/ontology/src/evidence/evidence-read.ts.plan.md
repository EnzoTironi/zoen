// @zoen-plan packages/ontology/src/evidence/evidence-read.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/evidence/evidence-read.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/evidence/evidence-read.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
