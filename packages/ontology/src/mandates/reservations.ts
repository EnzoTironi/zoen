// @zoen-plan packages/ontology/src/mandates/reservations.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/mandates/reservations.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/mandates/reservations.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// PROCEDURE ZN_0141 /* planning label, not a public API */
//   OWNER := SPEC-024; TARGET := packages/ontology/src/mandates/reservations.ts
//   REQUIRE accepted dependencies: ZN-0123, ZN-0134, ZN-0139
...
//     01. Use exact decimals and lock the full root/child budget path.
//     02. Reserve atomically with the Case and track committed/pending/settled/released/unknown states.
//     03. Reject overspend across concurrent independent child workers.
//   TEST BEFORE DECLARING THIS SEGMENT COMPLETE:
//     GIVEN Two children each request 70.00 against a shared 100.00 budget
//     WHEN Reservations race
//     THEN At most one 70.00 reservation succeeds; aggregate reserved plus spent never exceeds the admitted limit
