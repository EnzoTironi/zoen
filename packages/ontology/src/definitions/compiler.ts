// @zoen-plan packages/ontology/src/definitions/compiler.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/definitions/compiler.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/definitions/compiler.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// PROCEDURE ZN_0078 /* planning label, not a public API */
//   OWNER := SPEC-013; TARGET := packages/ontology/src/definitions/compiler.ts
//   REQUIRE accepted dependencies: ZN-0077
...
//     01. Resolve immutable local dependencies and reject unresolved remote references.
//     02. Emit normalized typed plans, dependency graph, operation schemas and presentation facets.
//     03. Hash and sign exact bytes with the admitted signer; tenant-facing references stay opaque.
//   TEST BEFORE DECLARING THIS SEGMENT COMPLETE:
//     GIVEN Identical definitions arrive via CLI, Studio and a chat proposal
//     WHEN Each compiles against the same kernel ABI and dependencies
//     THEN All produce identical release/manifest digests and no surface-specific semantic fork
