// @zoen-plan packages/ontology/src/definitions/standards.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/definitions/standards.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/definitions/standards.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
