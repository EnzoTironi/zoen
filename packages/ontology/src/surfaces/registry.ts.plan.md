# File plan — `packages/ontology/src/surfaces/registry.ts`

**Status:** candidate-unaccepted; no product acceptance implied.

Target: `packages/ontology/src/surfaces/registry.ts`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
