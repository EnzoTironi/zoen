// @zoen-plan packages/ontology/src/artifacts/artifact-envelope.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/artifacts/artifact-envelope.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/artifacts/artifact-envelope.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
