// @zoen-plan packages/ontology/src/worlds/world-entry.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/worlds/world-entry.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/worlds/world-entry.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
