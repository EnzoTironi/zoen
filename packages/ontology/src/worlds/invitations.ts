// @zoen-plan packages/ontology/src/worlds/invitations.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/worlds/invitations.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/worlds/invitations.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
// Specs: [SPEC-002](../../../../docs/specs/spec-002.md).
// Tickets: [ZN-0016](../../../../docs/tickets/zn-0016.md).
//
