// @zoen-plan packages/ontology/src/worlds/revocation.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/worlds/revocation.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/worlds/revocation.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
