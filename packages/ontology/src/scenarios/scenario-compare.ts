// @zoen-plan packages/ontology/src/scenarios/scenario-compare.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/ontology/src/scenarios/scenario-compare.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/ontology/src/scenarios/scenario-compare.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
// Specs: [SPEC-036](../../../../docs/specs/spec-036.md).
// Tickets: [ZN-0208](../../../../docs/tickets/zn-0208.md).
//
