// @zoen-plan packages/adapters/src/app-runtime/rivet/rivet-binding.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/adapters/src/app-runtime/rivet/rivet-binding.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/adapters/src/app-runtime/rivet/rivet-binding.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
