# File plan — `packages/adapters/src/semantic-http.ts`

**Status:** candidate-unaccepted; no product acceptance implied.

Target: `packages/adapters/src/semantic-http.ts`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
