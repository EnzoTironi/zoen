# File plan — `packages/adapters/src/cryptography.ts`

**Status:** candidate-unaccepted; no product acceptance implied.

Target: `packages/adapters/src/cryptography.ts`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
