# File plan — `packages/adapters/src/http-security.ts`

**Status:** candidate-unaccepted; no product acceptance implied.

Target: `packages/adapters/src/http-security.ts`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.

Specs: [SPEC-003](../../../docs/specs/spec-003.md), [SPEC-004](../../../docs/specs/spec-004.md), [SPEC-007](../../../docs/specs/spec-007.md).
