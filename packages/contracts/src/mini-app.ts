// @zoen-plan packages/contracts/src/mini-app.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/contracts/src/mini-app.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/contracts/src/mini-app.ts`. Representation: **comment-only-source**. Allocation: **conditional-support**.
//
