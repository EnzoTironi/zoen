// @zoen-plan packages/telemetry/src/types.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/telemetry/src/types.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/telemetry/src/types.ts`. Representation: **comment-only-source**. Allocation: **conditional-support**.
//
