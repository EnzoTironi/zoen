// @zoen-plan packages/eve/src/context/types.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/eve/src/context/types.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/eve/src/context/types.ts`. Representation: **comment-only-source**. Allocation: **conditional-support**.
//
