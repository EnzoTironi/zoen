// @zoen-plan packages/eve/src/context/compaction.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/eve/src/context/compaction.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/eve/src/context/compaction.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// PROCEDURE ZN_0059 /* planning label, not a public API */
//   OWNER := SPEC-010; TARGET := packages/eve/src/context/compaction.ts
//   REQUIRE accepted dependencies: ZN-0058
...
//     01. Summarize only settled visible interaction with a through-message cursor.
//     02. Label summaries as non-authoritative interaction aids.
//     03. Reopen factual claims through Ontology and remove summaries affected by erasure or access loss.
//   TEST BEFORE DECLARING THIS SEGMENT COMPLETE:
//     GIVEN A prior summary says a bill was paid, but the source only contains an unverified human assertion
//     WHEN A later answer is composed
//     THEN The summary cannot upgrade payment verification or bypass evidence checks
