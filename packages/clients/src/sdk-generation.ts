// @zoen-plan packages/clients/src/sdk-generation.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `packages/clients/src/sdk-generation.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `packages/clients/src/sdk-generation.ts`. Representation: **comment-only-source**. Allocation: **required**.
//
...
//
// ```text
// PROCEDURE ZN_0155 /* planning label, not a public API */
//   OWNER := SPEC-026; TARGET := packages/clients/src/sdk-generation.ts
//   REQUIRE accepted dependencies: ZN-0154
...
//     01. Emit typed request/result/error unions and manifest digest.
//     02. Separate dynamic client discovery from compile-time typed wrappers.
//     03. Return ContractChanged on incompatible server contracts and provide a regeneration path.
...
//     GIVEN A runtime release changes an action input incompatibly after SDK generation
//     WHEN The old client calls the operation
//     THEN The call fails explicitly; its old static types are not falsely presented as updated at runtime
