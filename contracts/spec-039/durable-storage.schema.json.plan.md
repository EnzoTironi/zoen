# File plan — `contracts/spec-039/durable-storage.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-039/durable-storage.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
