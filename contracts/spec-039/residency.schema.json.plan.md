# File plan — `contracts/spec-039/residency.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-039/residency.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
