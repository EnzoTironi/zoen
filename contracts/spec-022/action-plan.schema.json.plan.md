# File plan — `contracts/spec-022/action-plan.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-022/action-plan.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
