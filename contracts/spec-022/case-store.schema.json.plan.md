# File plan — `contracts/spec-022/case-store.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-022/case-store.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
