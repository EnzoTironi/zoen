# File plan — `contracts/spec-008/restore-baseline.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-008/restore-baseline.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
