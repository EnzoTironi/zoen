# File plan — `contracts/spec-008/legacy-import.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-008/legacy-import.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
