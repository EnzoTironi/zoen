# File plan — `contracts/spec-008/redaction.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-008/redaction.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
