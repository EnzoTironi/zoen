# File plan — `contracts/spec-017/question-priority.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-017/question-priority.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
