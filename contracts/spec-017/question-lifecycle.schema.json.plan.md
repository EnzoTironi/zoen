# File plan — `contracts/spec-017/question-lifecycle.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-017/question-lifecycle.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
