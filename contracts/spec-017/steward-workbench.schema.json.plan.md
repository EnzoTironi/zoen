# File plan — `contracts/spec-017/steward-workbench.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-017/steward-workbench.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
