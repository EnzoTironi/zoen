# File plan — `contracts/spec-002/entry-isolation.schema.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `contracts/spec-002/entry-isolation.schema.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
