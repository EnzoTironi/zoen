# File plan — `contracts/spec-002/presence.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-002/presence.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
