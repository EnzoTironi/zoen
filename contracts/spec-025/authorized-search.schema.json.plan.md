# File plan — `contracts/spec-025/authorized-search.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-025/authorized-search.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
