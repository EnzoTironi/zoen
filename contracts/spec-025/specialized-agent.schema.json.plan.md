# File plan — `contracts/spec-025/specialized-agent.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-025/specialized-agent.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
