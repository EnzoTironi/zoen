# File plan — `contracts/spec-025/search-frame.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-025/search-frame.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
