# File plan — `contracts/spec-025/retrieval-journey.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-025/retrieval-journey.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
