# File plan — `contracts/spec-025/search-projection.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-025/search-projection.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
