# File plan — `contracts/spec-050/executor-binding.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-050/executor-binding.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
