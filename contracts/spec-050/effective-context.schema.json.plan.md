# File plan — `contracts/spec-050/effective-context.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-050/effective-context.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
