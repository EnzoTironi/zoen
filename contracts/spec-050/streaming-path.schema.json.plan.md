# File plan — `contracts/spec-050/streaming-path.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-050/streaming-path.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
