# File plan — `contracts/spec-055/action-parity.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-055/action-parity.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
