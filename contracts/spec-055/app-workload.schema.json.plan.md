# File plan — `contracts/spec-055/app-workload.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-055/app-workload.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
