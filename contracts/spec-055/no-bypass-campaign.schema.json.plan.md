# File plan — `contracts/spec-055/no-bypass-campaign.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-055/no-bypass-campaign.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
