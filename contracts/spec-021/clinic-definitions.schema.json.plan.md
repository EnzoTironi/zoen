# File plan — `contracts/spec-021/clinic-definitions.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-021/clinic-definitions.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
