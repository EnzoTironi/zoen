# File plan — `contracts/spec-021/clinic-availability.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-021/clinic-availability.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
