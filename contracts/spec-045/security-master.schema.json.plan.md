# File plan — `contracts/spec-045/security-master.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-045/security-master.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
