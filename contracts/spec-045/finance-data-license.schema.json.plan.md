# File plan — `contracts/spec-045/finance-data-license.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-045/finance-data-license.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
