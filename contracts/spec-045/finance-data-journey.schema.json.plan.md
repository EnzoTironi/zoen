# File plan — `contracts/spec-045/finance-data-journey.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-045/finance-data-journey.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
