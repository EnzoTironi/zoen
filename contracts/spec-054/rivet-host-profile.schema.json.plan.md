# File plan — `contracts/spec-054/rivet-host-profile.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-054/rivet-host-profile.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
