# File plan — `contracts/spec-027/view-journey.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-027/view-journey.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.

Specs: [SPEC-027](../../docs/specs/spec-027.md).
Tickets: [ZN-0163](../../docs/tickets/zn-0163.md).
