# File plan — `contracts/spec-028/channel-continuity.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-028/channel-continuity.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
