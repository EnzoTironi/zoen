# File plan — `contracts/spec-036/training-manifest.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-036/training-manifest.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
