# File plan — `contracts/spec-036/model-registry.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-036/model-registry.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
