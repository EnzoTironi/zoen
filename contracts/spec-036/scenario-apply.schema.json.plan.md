# File plan — `contracts/spec-036/scenario-apply.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-036/scenario-apply.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
