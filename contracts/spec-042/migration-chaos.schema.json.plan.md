# File plan — `contracts/spec-042/migration-chaos.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-042/migration-chaos.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
