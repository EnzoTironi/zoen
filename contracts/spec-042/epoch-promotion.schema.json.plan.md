# File plan — `contracts/spec-042/epoch-promotion.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-042/epoch-promotion.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
