# File plan — `contracts/spec-042/source-fence.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-042/source-fence.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
