# File plan — `contracts/spec-042/cell-directory.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-042/cell-directory.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
