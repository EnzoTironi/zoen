# File plan — `contracts/spec-024/outcome-observation.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-024/outcome-observation.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
