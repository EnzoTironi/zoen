# File plan — `contracts/spec-024/mandate-contract.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-024/mandate-contract.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
