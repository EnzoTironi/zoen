# File plan — `contracts/spec-024/mandate-stop.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-024/mandate-stop.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
