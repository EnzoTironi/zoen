# File plan — `contracts/spec-015/oauth-binding.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-015/oauth-binding.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
