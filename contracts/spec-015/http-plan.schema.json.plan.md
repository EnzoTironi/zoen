# File plan — `contracts/spec-015/http-plan.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-015/http-plan.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
