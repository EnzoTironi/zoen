# File plan — `contracts/spec-006/identity-case.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-006/identity-case.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
