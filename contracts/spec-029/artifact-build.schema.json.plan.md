# File plan — `contracts/spec-029/artifact-build.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-029/artifact-build.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
