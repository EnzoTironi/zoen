# File plan — `contracts/spec-013/capability-definitions.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-013/capability-definitions.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
