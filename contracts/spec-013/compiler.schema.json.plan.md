# File plan — `contracts/spec-013/compiler.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-013/compiler.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
