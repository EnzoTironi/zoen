# File plan — `contracts/spec-013/semantic-diff.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-013/semantic-diff.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
