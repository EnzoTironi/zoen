# File plan — `contracts/spec-013/ontology-grammar.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-013/ontology-grammar.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
