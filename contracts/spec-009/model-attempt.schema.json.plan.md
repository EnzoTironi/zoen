# File plan — `contracts/spec-009/model-attempt.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-009/model-attempt.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
