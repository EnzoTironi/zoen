# File plan — `contracts/spec-009/turn-store.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-009/turn-store.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
