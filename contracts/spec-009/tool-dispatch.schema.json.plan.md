# File plan — `contracts/spec-009/tool-dispatch.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-009/tool-dispatch.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
