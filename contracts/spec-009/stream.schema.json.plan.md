# File plan — `contracts/spec-009/stream.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-009/stream.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
