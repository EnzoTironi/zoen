# File plan — `contracts/spec-052/private-app-journey.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-052/private-app-journey.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
