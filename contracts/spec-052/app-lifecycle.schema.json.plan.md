# File plan — `contracts/spec-052/app-lifecycle.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-052/app-lifecycle.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
