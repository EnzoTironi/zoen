# File plan — `contracts/spec-018/cedar-admission.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-018/cedar-admission.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
