# File plan — `contracts/spec-018/rights-noninterference.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-018/rights-noninterference.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
