# File plan — `contracts/spec-018/audience-view.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-018/audience-view.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
