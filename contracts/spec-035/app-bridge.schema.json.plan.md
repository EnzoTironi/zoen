# File plan — `contracts/spec-035/app-bridge.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-035/app-bridge.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
