# File plan — `contracts/spec-031/dense-profile.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-031/dense-profile.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
