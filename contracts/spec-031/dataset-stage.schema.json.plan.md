# File plan — `contracts/spec-031/dataset-stage.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-031/dataset-stage.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
