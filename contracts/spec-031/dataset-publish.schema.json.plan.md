# File plan — `contracts/spec-031/dataset-publish.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-031/dataset-publish.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
