# File plan — `contracts/spec-031/dataset-read.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-031/dataset-read.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
