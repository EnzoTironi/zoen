# File plan — `contracts/spec-032/quality-lineage.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-032/quality-lineage.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
