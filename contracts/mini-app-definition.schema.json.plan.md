# File plan — `contracts/mini-app-definition.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/mini-app-definition.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
