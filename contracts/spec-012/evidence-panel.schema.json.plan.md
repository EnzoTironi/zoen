# File plan — `contracts/spec-012/evidence-panel.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-012/evidence-panel.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
