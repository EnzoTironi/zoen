# File plan — `contracts/spec-012/accessibility.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-012/accessibility.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
