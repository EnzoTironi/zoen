# File plan — `contracts/spec-012/onboarding.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-012/onboarding.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
