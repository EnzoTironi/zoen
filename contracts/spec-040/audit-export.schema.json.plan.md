# File plan — `contracts/spec-040/audit-export.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-040/audit-export.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
