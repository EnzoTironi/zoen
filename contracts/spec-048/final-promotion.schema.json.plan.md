# File plan — `contracts/spec-048/final-promotion.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-048/final-promotion.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
