# File plan — `contracts/spec-048/enterprise-capstone.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-048/enterprise-capstone.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.

Specs: [SPEC-048](../../docs/specs/spec-048.md).
Tickets: [ZN-0283](../../docs/tickets/zn-0283.md).
