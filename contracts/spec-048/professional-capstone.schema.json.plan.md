# File plan — `contracts/spec-048/professional-capstone.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-048/professional-capstone.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
