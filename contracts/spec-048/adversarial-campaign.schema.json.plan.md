# File plan — `contracts/spec-048/adversarial-campaign.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-048/adversarial-campaign.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
