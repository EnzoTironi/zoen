# File plan — `contracts/spec-001/ids.schema.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `contracts/spec-001/ids.schema.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
