# File plan — `contracts/spec-053/guest-backend.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-053/guest-backend.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
