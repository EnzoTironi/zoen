# File plan — `contracts/spec-053/bridge-transport.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-053/bridge-transport.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
