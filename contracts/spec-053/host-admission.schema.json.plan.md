# File plan — `contracts/spec-053/host-admission.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-053/host-admission.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
