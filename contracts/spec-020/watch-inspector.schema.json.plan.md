# File plan — `contracts/spec-020/watch-inspector.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-020/watch-inspector.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
