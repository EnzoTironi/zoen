# File plan — `contracts/spec-020/notice-disclosure.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-020/notice-disclosure.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
