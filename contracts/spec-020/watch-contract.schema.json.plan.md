# File plan — `contracts/spec-020/watch-contract.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-020/watch-contract.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
