# File plan — `contracts/spec-020/attention-policy.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-020/attention-policy.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
