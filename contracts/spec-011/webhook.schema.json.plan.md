# File plan — `contracts/spec-011/webhook.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-011/webhook.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
