# File plan — `contracts/spec-011/delivery.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-011/delivery.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
