# File plan — `contracts/spec-011/whatsapp-qualification.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-011/whatsapp-qualification.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
