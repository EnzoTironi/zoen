# File plan — `contracts/spec-010/compile-context.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-010/compile-context.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
