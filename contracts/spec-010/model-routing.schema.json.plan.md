# File plan — `contracts/spec-010/model-routing.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-010/model-routing.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
