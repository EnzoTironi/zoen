# File plan — `contracts/spec-010/composition.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-010/composition.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
