# File plan — `contracts/spec-038/identity-provider-qualification.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-038/identity-provider-qualification.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
