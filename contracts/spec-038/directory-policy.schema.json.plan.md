# File plan — `contracts/spec-038/directory-policy.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-038/directory-policy.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
