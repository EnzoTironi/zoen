# File plan — `contracts/spec-038/enterprise-sso.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-038/enterprise-sso.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
