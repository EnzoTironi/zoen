# File plan — `contracts/spec-003/commit.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-003/commit.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
