# File plan — `contracts/spec-003/idempotency.schema.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `contracts/spec-003/idempotency.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
