# File plan — `contracts/spec-003/schema.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-003/schema.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
