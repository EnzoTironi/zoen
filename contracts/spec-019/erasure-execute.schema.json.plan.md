# File plan — `contracts/spec-019/erasure-execute.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-019/erasure-execute.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
