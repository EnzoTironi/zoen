# File plan — `contracts/spec-019/retention-policy.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-019/retention-policy.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
