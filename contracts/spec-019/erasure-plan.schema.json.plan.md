# File plan — `contracts/spec-019/erasure-plan.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-019/erasure-plan.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
