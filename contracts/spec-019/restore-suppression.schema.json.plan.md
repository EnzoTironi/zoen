# File plan — `contracts/spec-019/restore-suppression.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-019/restore-suppression.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
