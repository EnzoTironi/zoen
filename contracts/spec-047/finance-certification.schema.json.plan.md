# File plan — `contracts/spec-047/finance-certification.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-047/finance-certification.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
