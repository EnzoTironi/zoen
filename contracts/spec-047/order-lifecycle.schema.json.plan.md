# File plan — `contracts/spec-047/order-lifecycle.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-047/order-lifecycle.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
