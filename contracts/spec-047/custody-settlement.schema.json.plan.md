# File plan — `contracts/spec-047/custody-settlement.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-047/custody-settlement.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
