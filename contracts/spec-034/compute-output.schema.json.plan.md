# File plan — `contracts/spec-034/compute-output.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-034/compute-output.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
