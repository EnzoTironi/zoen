# File plan — `contracts/spec-034/virtual-source.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-034/virtual-source.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
