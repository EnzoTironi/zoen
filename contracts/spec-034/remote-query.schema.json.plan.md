# File plan — `contracts/spec-034/remote-query.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-034/remote-query.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
