# File plan — `contracts/spec-034/distributed-contract.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-034/distributed-contract.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
