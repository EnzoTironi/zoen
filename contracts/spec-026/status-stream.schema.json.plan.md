# File plan — `contracts/spec-026/status-stream.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-026/status-stream.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
