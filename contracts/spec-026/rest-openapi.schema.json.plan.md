# File plan — `contracts/spec-026/rest-openapi.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-026/rest-openapi.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
