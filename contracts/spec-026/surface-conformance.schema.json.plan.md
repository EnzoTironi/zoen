# File plan — `contracts/spec-026/surface-conformance.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-026/surface-conformance.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
