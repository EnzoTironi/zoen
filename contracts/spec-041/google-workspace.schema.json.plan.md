# File plan — `contracts/spec-041/google-workspace.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-041/google-workspace.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
