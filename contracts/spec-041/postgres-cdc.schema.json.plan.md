# File plan — `contracts/spec-041/postgres-cdc.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-041/postgres-cdc.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
