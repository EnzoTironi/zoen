# File plan — `contracts/spec-041/warehouse.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-041/warehouse.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
