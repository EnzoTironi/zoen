# File plan — `contracts/spec-041/microsoft365.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-041/microsoft365.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
