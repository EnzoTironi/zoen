# File plan — `contracts/spec-016/bakery-pack.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-016/bakery-pack.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
