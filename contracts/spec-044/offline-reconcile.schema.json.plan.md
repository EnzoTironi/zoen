# File plan — `contracts/spec-044/offline-reconcile.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-044/offline-reconcile.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
