# File plan — `contracts/spec-044/fleet-policy.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-044/fleet-policy.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
