# File plan — `contracts/spec-044/edge-profile-admission.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-044/edge-profile-admission.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
