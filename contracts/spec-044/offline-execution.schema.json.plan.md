# File plan — `contracts/spec-044/offline-execution.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-044/offline-execution.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
