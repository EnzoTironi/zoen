# File plan — `contracts/spec-005/impact.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-005/impact.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
