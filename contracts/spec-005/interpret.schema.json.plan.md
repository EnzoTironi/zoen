# File plan — `contracts/spec-005/interpret.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-005/interpret.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
