# File plan — `contracts/spec-030/capability-broker.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-030/capability-broker.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
