# File plan — `contracts/spec-030/runner-output.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-030/runner-output.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
