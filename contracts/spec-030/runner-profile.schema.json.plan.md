# File plan — `contracts/spec-030/runner-profile.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-030/runner-profile.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
