# File plan — `contracts/spec-007/discovery.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-007/discovery.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
