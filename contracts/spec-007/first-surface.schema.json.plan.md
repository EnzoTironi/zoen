# File plan — `contracts/spec-007/first-surface.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-007/first-surface.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
