# File plan — `contracts/spec-007/dispatch.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-007/dispatch.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
