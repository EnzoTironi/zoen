# File plan — `contracts/spec-043/federated-read.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-043/federated-read.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
