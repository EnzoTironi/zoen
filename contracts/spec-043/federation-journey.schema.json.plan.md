# File plan — `contracts/spec-043/federation-journey.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-043/federation-journey.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
