# File plan — `contracts/spec-043/federation-links.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-043/federation-links.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
