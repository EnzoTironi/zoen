# File plan — `contracts/spec-033/live-envelope.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-033/live-envelope.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
