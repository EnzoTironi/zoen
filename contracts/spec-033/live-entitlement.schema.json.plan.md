# File plan — `contracts/spec-033/live-entitlement.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-033/live-entitlement.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
