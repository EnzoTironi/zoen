# File plan — `contracts/spec-023/effect-reconcile.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-023/effect-reconcile.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
