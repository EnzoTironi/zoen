# File plan — `contracts/spec-023/effect-attempt.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-023/effect-attempt.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
