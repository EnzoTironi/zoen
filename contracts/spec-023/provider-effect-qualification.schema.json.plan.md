# File plan — `contracts/spec-023/provider-effect-qualification.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-023/provider-effect-qualification.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
