# File plan — `contracts/spec-000/supply-chain.schema.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `contracts/spec-000/supply-chain.schema.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
