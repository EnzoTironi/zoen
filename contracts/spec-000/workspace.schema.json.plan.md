# File plan — `contracts/spec-000/workspace.schema.json`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `contracts/spec-000/workspace.schema.json`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
