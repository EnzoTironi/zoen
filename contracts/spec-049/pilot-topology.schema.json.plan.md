# File plan — `contracts/spec-049/pilot-topology.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-049/pilot-topology.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
