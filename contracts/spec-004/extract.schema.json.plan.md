# File plan — `contracts/spec-004/extract.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-004/extract.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
