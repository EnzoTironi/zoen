# File plan — `contracts/spec-004/admission.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-004/admission.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
