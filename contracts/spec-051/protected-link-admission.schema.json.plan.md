# File plan — `contracts/spec-051/protected-link-admission.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-051/protected-link-admission.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
