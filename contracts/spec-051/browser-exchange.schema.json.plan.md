# File plan — `contracts/spec-051/browser-exchange.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-051/browser-exchange.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
