# File plan — `contracts/spec-051/app-sharing.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-051/app-sharing.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
