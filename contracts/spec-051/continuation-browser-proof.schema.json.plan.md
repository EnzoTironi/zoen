# File plan — `contracts/spec-051/continuation-browser-proof.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-051/continuation-browser-proof.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
