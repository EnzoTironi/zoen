# File plan — `contracts/spec-051/continuation-registry.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-051/continuation-registry.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
