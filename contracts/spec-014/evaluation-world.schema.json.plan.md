# File plan — `contracts/spec-014/evaluation-world.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-014/evaluation-world.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
