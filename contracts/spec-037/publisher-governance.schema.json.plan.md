# File plan — `contracts/spec-037/publisher-governance.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-037/publisher-governance.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
