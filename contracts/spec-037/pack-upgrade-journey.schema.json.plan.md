# File plan — `contracts/spec-037/pack-upgrade-journey.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-037/pack-upgrade-journey.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
