# File plan — `contracts/spec-037/pack-upgrade.schema.json`

**Status:** planned; no product acceptance implied.

Target: `contracts/spec-037/pack-upgrade.schema.json`. Representation: **sidecar-only**. Allocation: **conditional-support**.
