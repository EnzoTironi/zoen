// @zoen-plan runners/apps/rivet-entry.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `runners/apps/rivet-entry.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `runners/apps/rivet-entry.ts`. Representation: **comment-only-source**. Allocation: **conditional-support**.
//
