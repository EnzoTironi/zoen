// @zoen-plan runners/apps/ports.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `runners/apps/ports.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `runners/apps/ports.ts`. Representation: **comment-only-source**. Allocation: **conditional-support**.
//
