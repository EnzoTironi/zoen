// @zoen-plan runners/apps/types.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `runners/apps/types.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `runners/apps/types.ts`. Representation: **comment-only-source**. Allocation: **conditional-support**.
//
