// @zoen-plan runners/sql/entry.ts
// NON-EXECUTABLE PSEUDOCODE; not registered or compiled as product implementation.
// # File plan — `runners/sql/entry.ts`
//
// **Status:** planned; no product acceptance implied.
//
// Target: `runners/sql/entry.ts`. Representation: **comment-only-source**. Allocation: **conditional-support**.
//
