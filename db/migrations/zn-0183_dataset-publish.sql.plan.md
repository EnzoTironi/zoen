# File plan — `db/migrations/zn-0183_dataset-publish.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0183_dataset-publish.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
