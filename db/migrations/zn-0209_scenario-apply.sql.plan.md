# File plan — `db/migrations/zn-0209_scenario-apply.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0209_scenario-apply.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
