# File plan — `db/migrations/zn-0112_retention-policy.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0112_retention-policy.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
