# File plan — `db/migrations/zn-0275_cancel-replace.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0275_cancel-replace.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
