# File plan — `db/migrations/zn-0137_effect-attempt.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0137_effect-attempt.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
