# File plan — `db/migrations/zn-0207_scenario-store.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0207_scenario-store.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
