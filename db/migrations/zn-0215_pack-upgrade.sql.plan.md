# File plan — `db/migrations/zn-0215_pack-upgrade.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0215_pack-upgrade.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
