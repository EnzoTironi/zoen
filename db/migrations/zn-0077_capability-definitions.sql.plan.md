# File plan — `db/migrations/zn-0077_capability-definitions.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0077_capability-definitions.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
