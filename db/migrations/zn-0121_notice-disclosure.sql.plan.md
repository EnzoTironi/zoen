# File plan — `db/migrations/zn-0121_notice-disclosure.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0121_notice-disclosure.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
