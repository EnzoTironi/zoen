# File plan — `db/migrations/zn-0119_watch-evaluator.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0119_watch-evaluator.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
