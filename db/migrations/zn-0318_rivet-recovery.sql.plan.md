# File plan — `db/migrations/zn-0318_rivet-recovery.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0318_rivet-recovery.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
