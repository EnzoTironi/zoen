# File plan — `db/migrations/zn-0241_postgres-cdc.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0241_postgres-cdc.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
