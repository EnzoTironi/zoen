# File plan — `db/migrations/zn-0036_interpretation-laws.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0036_interpretation-laws.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
