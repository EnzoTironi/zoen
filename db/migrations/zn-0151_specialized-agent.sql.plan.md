# File plan — `db/migrations/zn-0151_specialized-agent.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0151_specialized-agent.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
