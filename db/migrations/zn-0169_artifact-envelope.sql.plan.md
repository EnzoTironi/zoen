# File plan — `db/migrations/zn-0169_artifact-envelope.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0169_artifact-envelope.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
