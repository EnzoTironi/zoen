# File plan — `db/migrations/zn-0076_expression-ir.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0076_expression-ir.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
