# File plan — `db/migrations/zn-0181_dataset-stage.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0181_dataset-stage.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
