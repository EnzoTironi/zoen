# File plan — `db/migrations/zn-0159_view-contracts.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0159_view-contracts.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
