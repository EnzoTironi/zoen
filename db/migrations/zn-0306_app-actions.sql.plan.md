# File plan — `db/migrations/zn-0306_app-actions.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0306_app-actions.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
