# File plan — `db/migrations/zn-0018_entry-isolation.sql`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `db/migrations/zn-0018_entry-isolation.sql`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
