# File plan — `db/migrations/zn-0079_semantic-diff.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0079_semantic-diff.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
