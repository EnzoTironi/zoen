# File plan — `db/migrations/zn-0257_offline-reconcile.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0257_offline-reconcile.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
