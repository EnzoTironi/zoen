# File plan — `db/migrations/zn-0124_clinic-definitions.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0124_clinic-definitions.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
