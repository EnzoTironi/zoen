# File plan — `db/migrations/zn-0066_send-policy.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0066_send-policy.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
