# File plan — `db/migrations/zn-0126_clinic-actions.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0126_clinic-actions.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
