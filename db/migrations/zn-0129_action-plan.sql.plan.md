# File plan — `db/migrations/zn-0129_action-plan.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0129_action-plan.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
