# File plan — `db/migrations/zn-0245_cell-directory.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0245_cell-directory.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
