# File plan — `db/migrations/zn-0108_derived-rights.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0108_derived-rights.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
