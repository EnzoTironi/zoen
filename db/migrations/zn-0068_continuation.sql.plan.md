# File plan — `db/migrations/zn-0068_continuation.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0068_continuation.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
