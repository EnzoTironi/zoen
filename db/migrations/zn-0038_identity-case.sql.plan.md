# File plan — `db/migrations/zn-0038_identity-case.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0038_identity-case.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
