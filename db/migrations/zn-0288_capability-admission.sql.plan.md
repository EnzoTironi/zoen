# File plan — `db/migrations/zn-0288_capability-admission.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0288_capability-admission.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
