# File plan — `db/migrations/zn-0172_artifact-recall.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0172_artifact-recall.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
