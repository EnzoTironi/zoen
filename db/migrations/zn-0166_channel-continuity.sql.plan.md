# File plan — `db/migrations/zn-0166_channel-continuity.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0166_channel-continuity.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
