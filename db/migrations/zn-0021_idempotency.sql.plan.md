# File plan — `db/migrations/zn-0021_idempotency.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0021_idempotency.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
