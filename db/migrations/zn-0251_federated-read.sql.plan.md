# File plan — `db/migrations/zn-0251_federated-read.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0251_federated-read.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
