# File plan — `db/migrations/zn-0013_presence.sql`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `db/migrations/zn-0013_presence.sql`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
