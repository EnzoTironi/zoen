# File plan — `db/migrations/zn-0264_financial-news.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0264_financial-news.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
