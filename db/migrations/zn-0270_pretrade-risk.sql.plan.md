# File plan — `db/migrations/zn-0270_pretrade-risk.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0270_pretrade-risk.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
