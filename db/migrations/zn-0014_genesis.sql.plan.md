# File plan — `db/migrations/zn-0014_genesis.sql`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `db/migrations/zn-0014_genesis.sql`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
