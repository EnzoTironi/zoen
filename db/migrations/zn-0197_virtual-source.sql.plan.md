# File plan — `db/migrations/zn-0197_virtual-source.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0197_virtual-source.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
