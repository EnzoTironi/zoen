# File plan — `db/migrations/zn-0271_risk-models.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0271_risk-models.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
