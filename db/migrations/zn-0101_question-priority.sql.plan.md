# File plan — `db/migrations/zn-0101_question-priority.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0101_question-priority.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
