# File plan — `db/migrations/zn-0110_rights-freshness.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0110_rights-freshness.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
