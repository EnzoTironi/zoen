# File plan — `db/migrations/zn-0149_search-frame.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0149_search-frame.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
