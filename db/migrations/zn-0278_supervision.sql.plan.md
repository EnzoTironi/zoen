# File plan — `db/migrations/zn-0278_supervision.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0278_supervision.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
