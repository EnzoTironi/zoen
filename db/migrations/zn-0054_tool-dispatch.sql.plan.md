# File plan — `db/migrations/zn-0054_tool-dispatch.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0054_tool-dispatch.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
