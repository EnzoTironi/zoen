# File plan — `db/migrations/zn-0177_analysis-profiles.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0177_analysis-profiles.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
