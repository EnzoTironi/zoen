# File plan — `db/migrations/zn-0300_app-sharing.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0300_app-sharing.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
