# File plan — `db/migrations/zn-0122_watch-inspector.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0122_watch-inspector.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
