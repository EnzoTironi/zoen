# File plan — `db/migrations/zn-0219_enterprise-sso.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0219_enterprise-sso.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
