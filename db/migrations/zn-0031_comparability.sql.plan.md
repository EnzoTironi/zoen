# File plan — `db/migrations/zn-0031_comparability.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0031_comparability.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
