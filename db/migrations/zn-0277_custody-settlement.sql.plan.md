# File plan — `db/migrations/zn-0277_custody-settlement.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0277_custody-settlement.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
