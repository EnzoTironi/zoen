# File plan — `db/migrations/zn-0255_offline-lease.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0255_offline-lease.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
