# File plan — `db/migrations/zn-0176_runner-limits.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0176_runner-limits.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
