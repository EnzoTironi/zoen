# File plan — `db/migrations/zn-0316_rivet-binding.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0316_rivet-binding.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
