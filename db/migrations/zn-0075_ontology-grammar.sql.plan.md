# File plan — `db/migrations/zn-0075_ontology-grammar.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0075_ontology-grammar.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
