# File plan — `db/migrations/zn-0017_revocation.sql`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `db/migrations/zn-0017_revocation.sql`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
