# File plan — `db/migrations/zn-0082_change-lanes.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0082_change-lanes.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
