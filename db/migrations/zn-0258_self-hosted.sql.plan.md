# File plan — `db/migrations/zn-0258_self-hosted.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0258_self-hosted.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
