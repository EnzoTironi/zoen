# File plan — `db/migrations/zn-0246_migration-stage.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0246_migration-stage.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
