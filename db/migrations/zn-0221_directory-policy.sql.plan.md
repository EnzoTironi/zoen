# File plan — `db/migrations/zn-0221_directory-policy.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0221_directory-policy.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
