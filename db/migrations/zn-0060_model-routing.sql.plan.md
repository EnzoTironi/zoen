# File plan — `db/migrations/zn-0060_model-routing.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0060_model-routing.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
