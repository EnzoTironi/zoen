# File plan — `db/migrations/zn-0175_capability-broker.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0175_capability-broker.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
