# File plan — `db/migrations/zn-0142_mandate-contract.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0142_mandate-contract.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
