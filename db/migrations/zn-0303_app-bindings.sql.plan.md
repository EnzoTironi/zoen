# File plan — `db/migrations/zn-0303_app-bindings.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0303_app-bindings.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
