# File plan — `db/migrations/zn-0302_app-definition.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0302_app-definition.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
