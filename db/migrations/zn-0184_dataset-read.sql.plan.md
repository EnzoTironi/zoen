# File plan — `db/migrations/zn-0184_dataset-read.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0184_dataset-read.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
