# File plan — `db/migrations/zn-0314_rivet-api-probe.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0314_rivet-api-probe.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
