# File plan — `db/migrations/zn-0098_bakery-pack.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0098_bakery-pack.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
