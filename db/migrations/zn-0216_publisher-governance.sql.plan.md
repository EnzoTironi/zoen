# File plan — `db/migrations/zn-0216_publisher-governance.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0216_publisher-governance.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
