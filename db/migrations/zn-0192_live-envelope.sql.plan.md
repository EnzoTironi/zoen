# File plan — `db/migrations/zn-0192_live-envelope.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0192_live-envelope.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
