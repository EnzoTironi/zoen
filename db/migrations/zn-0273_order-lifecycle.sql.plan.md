# File plan — `db/migrations/zn-0273_order-lifecycle.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0273_order-lifecycle.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
