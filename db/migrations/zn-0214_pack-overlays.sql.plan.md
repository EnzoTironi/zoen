# File plan — `db/migrations/zn-0214_pack-overlays.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0214_pack-overlays.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
