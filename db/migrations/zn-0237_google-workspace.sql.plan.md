# File plan — `db/migrations/zn-0237_google-workspace.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0237_google-workspace.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
