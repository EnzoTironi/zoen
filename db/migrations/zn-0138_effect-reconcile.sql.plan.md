# File plan — `db/migrations/zn-0138_effect-reconcile.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0138_effect-reconcile.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
