# File plan — `db/migrations/zn-0046_frame-disclosure.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0046_frame-disclosure.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
