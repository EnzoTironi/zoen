# File plan — `db/migrations/zn-0299_app-sessions.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0299_app-sessions.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
