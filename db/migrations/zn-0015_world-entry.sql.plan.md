# File plan — `db/migrations/zn-0015_world-entry.sql`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `db/migrations/zn-0015_world-entry.sql`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
