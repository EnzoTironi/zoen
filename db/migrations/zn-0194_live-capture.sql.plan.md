# File plan — `db/migrations/zn-0194_live-capture.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0194_live-capture.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
