# File plan — `db/migrations/zn-0120_attention-policy.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0120_attention-policy.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
