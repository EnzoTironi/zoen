# File plan — `db/migrations/zn-0261_security-master.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0261_security-master.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
