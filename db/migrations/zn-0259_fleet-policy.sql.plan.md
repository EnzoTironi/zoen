# File plan — `db/migrations/zn-0259_fleet-policy.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0259_fleet-policy.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
