# File plan — `db/migrations/zn-0132_case-commit.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0132_case-commit.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
