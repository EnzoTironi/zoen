# File plan — `db/migrations/zn-0027_evidence-read.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0027_evidence-read.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
