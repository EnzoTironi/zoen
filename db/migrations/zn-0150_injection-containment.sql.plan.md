# File plan — `db/migrations/zn-0150_injection-containment.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0150_injection-containment.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
