# File plan — `db/migrations/zn-0174_runner-profile.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0174_runner-profile.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
