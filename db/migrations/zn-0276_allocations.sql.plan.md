# File plan — `db/migrations/zn-0276_allocations.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0276_allocations.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
