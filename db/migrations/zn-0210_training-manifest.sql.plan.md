# File plan — `db/migrations/zn-0210_training-manifest.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0210_training-manifest.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
