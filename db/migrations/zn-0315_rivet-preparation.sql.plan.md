# File plan — `db/migrations/zn-0315_rivet-preparation.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0315_rivet-preparation.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
