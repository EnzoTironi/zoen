# File plan — `db/migrations/zn-0042_frame-basis.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0042_frame-basis.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
