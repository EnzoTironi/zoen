# File plan — `db/migrations/zn-0114_erasure-execute.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0114_erasure-execute.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
