# File plan — `db/migrations/zn-0061_composition.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0061_composition.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
