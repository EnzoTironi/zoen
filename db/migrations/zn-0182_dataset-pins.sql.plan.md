# File plan — `db/migrations/zn-0182_dataset-pins.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0182_dataset-pins.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
