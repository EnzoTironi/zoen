# File plan — `db/migrations/zn-0225_dedicated-cell.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0225_dedicated-cell.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
