# File plan — `db/migrations/zn-0065_channel-binding.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0065_channel-binding.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
