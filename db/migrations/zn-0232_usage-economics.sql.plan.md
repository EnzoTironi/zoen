# File plan — `db/migrations/zn-0232_usage-economics.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0232_usage-economics.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
