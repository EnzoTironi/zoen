# File plan — `db/migrations/zn-0262_corporate-actions.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0262_corporate-actions.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
