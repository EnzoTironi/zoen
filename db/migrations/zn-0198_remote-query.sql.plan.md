# File plan — `db/migrations/zn-0198_remote-query.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0198_remote-query.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
