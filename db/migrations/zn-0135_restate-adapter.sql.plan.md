# File plan — `db/migrations/zn-0135_restate-adapter.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0135_restate-adapter.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
