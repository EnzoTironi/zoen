# File plan — `db/migrations/zn-0148_authorized-search.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0148_authorized-search.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
