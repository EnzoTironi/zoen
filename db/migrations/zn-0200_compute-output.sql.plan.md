# File plan — `db/migrations/zn-0200_compute-output.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0200_compute-output.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
