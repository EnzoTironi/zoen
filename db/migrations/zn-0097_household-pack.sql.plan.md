# File plan — `db/migrations/zn-0097_household-pack.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0097_household-pack.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
