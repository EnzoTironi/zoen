# File plan — `db/migrations/zn-0113_erasure-plan.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0113_erasure-plan.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
