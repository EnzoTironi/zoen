# File plan — `db/migrations/zn-0248_epoch-promotion.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0248_epoch-promotion.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
