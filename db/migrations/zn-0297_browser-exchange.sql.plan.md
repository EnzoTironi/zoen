# File plan — `db/migrations/zn-0297_browser-exchange.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0297_browser-exchange.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
