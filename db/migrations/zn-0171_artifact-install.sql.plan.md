# File plan — `db/migrations/zn-0171_artifact-install.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0171_artifact-install.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
