# File plan — `db/migrations/zn-0016_invitations.sql`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `db/migrations/zn-0016_invitations.sql`. Representation: **existing-with-sidecar**. Allocation: **conditional-support**.
