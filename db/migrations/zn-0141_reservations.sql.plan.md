# File plan — `db/migrations/zn-0141_reservations.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0141_reservations.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
