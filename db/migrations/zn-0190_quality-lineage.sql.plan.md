# File plan — `db/migrations/zn-0190_quality-lineage.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0190_quality-lineage.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
