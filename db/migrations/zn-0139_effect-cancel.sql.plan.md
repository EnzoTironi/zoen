# File plan — `db/migrations/zn-0139_effect-cancel.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0139_effect-cancel.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
