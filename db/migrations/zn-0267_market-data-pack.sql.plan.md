# File plan — `db/migrations/zn-0267_market-data-pack.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0267_market-data-pack.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
