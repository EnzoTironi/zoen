# File plan — `db/migrations/zn-0226_durable-storage.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0226_durable-storage.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
