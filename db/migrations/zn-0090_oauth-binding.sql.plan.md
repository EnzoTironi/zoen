# File plan — `db/migrations/zn-0090_oauth-binding.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0090_oauth-binding.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
