# File plan — `db/migrations/zn-0208_scenario-compare.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0208_scenario-compare.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
