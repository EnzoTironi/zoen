# File plan — `db/migrations/zn-0083_evaluation-world.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0083_evaluation-world.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
