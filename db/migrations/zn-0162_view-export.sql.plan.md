# File plan — `db/migrations/zn-0162_view-export.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0162_view-export.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
