# File plan — `db/migrations/zn-0304_app-publication.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0304_app-publication.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
