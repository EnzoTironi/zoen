# File plan — `db/migrations/zn-0289_pilot-rollout.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0289_pilot-rollout.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
