# File plan — `db/migrations/zn-0234_audit-export.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0234_audit-export.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
