# File plan — `db/migrations/zn-0250_federation-links.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0250_federation-links.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
