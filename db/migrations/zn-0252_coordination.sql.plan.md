# File plan — `db/migrations/zn-0252_coordination.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0252_coordination.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
