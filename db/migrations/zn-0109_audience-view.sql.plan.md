# File plan — `db/migrations/zn-0109_audience-view.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0109_audience-view.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
