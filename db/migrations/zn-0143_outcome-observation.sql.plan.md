# File plan — `db/migrations/zn-0143_outcome-observation.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0143_outcome-observation.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
