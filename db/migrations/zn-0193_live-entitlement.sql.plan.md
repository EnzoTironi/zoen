# File plan — `db/migrations/zn-0193_live-entitlement.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0193_live-entitlement.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
