# File plan — `db/migrations/zn-0096_foundation-pack.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0096_foundation-pack.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
