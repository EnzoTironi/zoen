# File plan — `db/migrations/zn-0167_channel-capabilities.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0167_channel-capabilities.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
