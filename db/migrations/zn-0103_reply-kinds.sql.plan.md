# File plan — `db/migrations/zn-0103_reply-kinds.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0103_reply-kinds.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
