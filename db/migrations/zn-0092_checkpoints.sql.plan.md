# File plan — `db/migrations/zn-0092_checkpoints.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0092_checkpoints.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
