# File plan — `db/migrations/zn-0317_rivet-host-profile.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0317_rivet-host-profile.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
