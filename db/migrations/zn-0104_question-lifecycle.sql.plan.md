# File plan — `db/migrations/zn-0104_question-lifecycle.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0104_question-lifecycle.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
