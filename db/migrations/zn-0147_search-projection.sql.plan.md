# File plan — `db/migrations/zn-0147_search-projection.sql`

**Status:** planned; no product acceptance implied.

Target: `db/migrations/zn-0147_search-projection.sql`. Representation: **sidecar-only**. Allocation: **conditional-support**.
