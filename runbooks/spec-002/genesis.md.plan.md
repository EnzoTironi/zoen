# File plan — `runbooks/spec-002/genesis.md`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `runbooks/spec-002/genesis.md`. Representation: **existing-with-sidecar**. Allocation: **required**.
...
## ZN-0014 operational/repair procedure

Scope: Implement idempotent private World genesis. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
Both commit through actual PostgreSQL
...
Exactly one World and one receipt exist; retries return its authorized reference
