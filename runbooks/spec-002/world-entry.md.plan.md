# File plan — `runbooks/spec-002/world-entry.md`

**Status:** implementation-in-progress; no product acceptance implied.

Target: `runbooks/spec-002/world-entry.md`. Representation: **existing-with-sidecar**. Allocation: **required**.
...
## ZN-0015 operational/repair procedure

Scope: Issue fresh purpose-bound grants and request permits. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
The grant is reused with the different operation/purpose
...
Access is denied; altered body, realm, audience and expired permit also fail without domain writes
