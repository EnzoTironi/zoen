# File plan — `runbooks/spec-007/frame-disclosure.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-007/frame-disclosure.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0046 operational/repair procedure

Scope: Reauthorize result disclosure and historical reopen. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
Each is reopened under the appropriate current principal
...
Revoked access yields no payload; erased content is unavailable; an authorized unchanged case reopens the pinned basis without silently refreshing it
