# File plan — `runbooks/spec-007/discovery.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-007/discovery.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0044 operational/repair procedure

Scope: Implement authorized discovery and explanation references. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
Each requests available fields and explanations
...
Only permitted capabilities appear; hidden clinical fields do not leak in schemas, counts, examples or error detail
