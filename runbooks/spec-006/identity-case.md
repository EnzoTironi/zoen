# File plan — `runbooks/spec-006/identity-case.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-006/identity-case.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0038 operational/repair procedure

Scope: Create guarded ambiguous-identity Cases. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
A user answers the older question
...
The reply returns Stale; no identity assignment occurs and no hidden patient candidate is exposed
