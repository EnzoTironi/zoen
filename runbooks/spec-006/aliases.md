# File plan — `runbooks/spec-006/aliases.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-006/aliases.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0037 operational/repair procedure

Scope: Implement namespaced aliases and stable subjects. This is a plan; deployments and commands not yet qualified remain blocked.
...
Four source identities remain distinguishable; the shared email is not proof of a single person
