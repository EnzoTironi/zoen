# File plan — `runbooks/spec-025/injection-containment.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-025/injection-containment.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0150 operational/repair procedure

Scope: Contain source prompt injection at tool boundaries. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
It is retrieved for a legitimate question
...
No authority expands and no export occurs; the relevant permitted content may still be cited as source data
