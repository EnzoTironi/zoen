# File plan — `runbooks/spec-025/retrieval-journey.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-025/retrieval-journey.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0152 operational/repair procedure

Scope: Prove retrieval and agent policies across source revocation. This is a plan; deployments and commands not yet qualified remain blocked.
...
Forbidden source content is suppressed and the analysis cannot be promoted to authoritative truth without current admissible evidence
