# File plan — `runbooks/spec-013/standards.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-013/standards.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0080 operational/repair procedure

Scope: Support explicit standards interchange profiles. This is a plan; deployments and commands not yet qualified remain blocked.
...
The supported graph round-trips; remote fetch is never attempted; unsupported semantics are explicitly rejected
