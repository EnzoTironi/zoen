# File plan — `runbooks/spec-013/expression-ir.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-013/expression-ir.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0076 operational/repair procedure

Scope: Implement the bounded expression and query IR. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
They compile and execute under the authority interpreter
...
The finite plan is deterministic; forbidden operations return UnsupportedPlan before execution
