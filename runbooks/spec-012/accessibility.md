# File plan — `runbooks/spec-012/accessibility.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-012/accessibility.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0071 operational/repair procedure

Scope: Implement keyboard and large-text accessible interaction. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
They upload a source, inspect a dispute and undo a reply
...
Every action is reachable with visible focus and no clipped essential content; screen-reader verification remains an explicit human gate
