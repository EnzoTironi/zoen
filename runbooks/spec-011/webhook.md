# File plan — `runbooks/spec-011/webhook.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-011/webhook.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0064 operational/repair procedure

Scope: Admit signed webhooks before acknowledgement. This is a plan; deployments and commands not yet qualified remain blocked.
...
Valid ingress is accepted once; invalid signatures are rejected; no success ACK precedes durability
