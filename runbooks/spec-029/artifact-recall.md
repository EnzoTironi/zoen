# File plan — `runbooks/spec-029/artifact-recall.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-029/artifact-recall.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0172 operational/repair procedure

Scope: Implement recall and deny new artifact leases. This is a plan; deployments and commands not yet qualified remain blocked.
...
Queued execution cannot start; in-flight uncertainty is reported rather than pretending recall undid the external request
