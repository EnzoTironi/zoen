# File plan — `runbooks/spec-029/artifact-build.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-029/artifact-build.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0170 operational/repair procedure

Scope: Build isolated provenance and dependency review pipeline. This is a plan; deployments and commands not yet qualified remain blocked.
...
Host/network isolation blocks it and the candidate fails qualification without exposing secrets
