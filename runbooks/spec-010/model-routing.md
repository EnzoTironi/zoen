# File plan — `runbooks/spec-010/model-routing.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-010/model-routing.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0060 operational/repair procedure

Scope: Implement permitted model routing and usage accounting. This is a plan; deployments and commands not yet qualified remain blocked.
...
It returns NoPermittedModel rather than exporting data; an allowed fallback records its actual identity and usage
