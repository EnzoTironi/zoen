# File plan — `runbooks/spec-042/migration-stage.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-042/migration-stage.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0246 operational/repair procedure

Scope: Stage destination copy and committed catch-up. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
The request arrives before promotion
...
It is denied; staged data never implies writable authority
