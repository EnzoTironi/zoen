# File plan — `runbooks/spec-044/self-hosted.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-044/self-hosted.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0258 operational/repair procedure

Scope: Define and test self-hosted infrastructure equivalence. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
It requests the full enterprise capability profile
...
Those capabilities remain disabled until equivalent controls are proved
