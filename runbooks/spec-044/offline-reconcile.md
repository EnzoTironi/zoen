# File plan — `runbooks/spec-044/offline-reconcile.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-044/offline-reconcile.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0257 operational/repair procedure

Scope: Reconcile child receipts without blind replay. This is a plan; deployments and commands not yet qualified remain blocked.
...
The parent preserves divergence and requests resolution; neither child silently overwrites parent truth
