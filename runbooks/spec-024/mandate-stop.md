# File plan — `runbooks/spec-024/mandate-stop.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-024/mandate-stop.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0144 operational/repair procedure

Scope: Enforce deadlines, repetition limits and emergency stop. This is a plan; deployments and commands not yet qualified remain blocked.
...
No new child action is allowed; unknown exposure remains reserved and an explicit escalation is recorded
