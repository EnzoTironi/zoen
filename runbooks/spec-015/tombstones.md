# File plan — `runbooks/spec-015/tombstones.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-015/tombstones.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0094 operational/repair procedure

Scope: Propagate explicit source tombstones safely. This is a plan; deployments and commands not yet qualified remain blocked.
...
Only the explicit/proven-complete deletion produces a tombstone; outage never invents nonexistence
