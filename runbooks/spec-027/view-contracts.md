# File plan — `runbooks/spec-027/view-contracts.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-027/view-contracts.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0159 operational/repair procedure

Scope: Define ChartDocument and table/timeline contracts. This is a plan; deployments and commands not yet qualified remain blocked.
...
Both are rejected; valid charts retain explicit unit/currency and temporal basis
