# File plan — `runbooks/spec-049/capability-admission.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-049/capability-admission.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0288 operational/repair procedure

Scope: Implement capability-specific deployment admission flags. This is a plan; deployments and commands not yet qualified remain blocked.
...
Web/file work; WhatsApp is explicitly disabled rather than mocked or falsely healthy
