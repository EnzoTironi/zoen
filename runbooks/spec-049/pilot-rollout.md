# File plan — `runbooks/spec-049/pilot-rollout.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-049/pilot-rollout.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0289 operational/repair procedure

Scope: Implement safe image/schema rollout and rollback. This is a plan; deployments and commands not yet qualified remain blocked.
...
Only a proven compatible rollback/forward repair proceeds; no blind binary revert corrupts active state
