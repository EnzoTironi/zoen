# File plan — `runbooks/spec-038/enterprise-sso.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-038/enterprise-sso.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0219 operational/repair procedure

Scope: Admit enterprise OIDC/SAML connections. This is a plan; deployments and commands not yet qualified remain blocked.
...
They remain separate principals unless an explicit verified linking operation occurs
