# File plan — `runbooks/spec-038/scim.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-038/scim.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0220 operational/repair procedure

Scope: Implement idempotent SCIM provisioning and deactivation. This is a plan; deployments and commands not yet qualified remain blocked.
...
The old update cannot resurrect the user or old grants; the deactivation receipt remains attributable
