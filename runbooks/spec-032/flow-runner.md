# File plan — `runbooks/spec-032/flow-runner.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-032/flow-runner.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0187 operational/repair procedure

Scope: Implement durable batch and incremental flow runs. This is a plan; deployments and commands not yet qualified remain blocked.
...
The same output is reused or safely re-admitted; no duplicate dataset publication or source cursor skip occurs
