# File plan — `runbooks/spec-032/quality-lineage.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-032/quality-lineage.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0190 operational/repair procedure

Scope: Implement field-level lineage and tri-state quality gates. This is a plan; deployments and commands not yet qualified remain blocked.
...
Completeness is unknown/fail rather than pass; the published metric cannot claim whole-company coverage
