# File plan — `runbooks/spec-041/postgres-cdc.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-041/postgres-cdc.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0241 operational/repair procedure

Scope: Implement PostgreSQL snapshot-plus-CDC source recipe. This is a plan; deployments and commands not yet qualified remain blocked.
...
A coverage gap is explicit and publication remains blocked until a verified new snapshot closes the gap
