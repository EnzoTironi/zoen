# File plan — `runbooks/spec-023/effect-attempt.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-023/effect-attempt.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0137 operational/repair procedure

Scope: Record attempt and ambiguous outcome states. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
The worker crashes and resumes
...
The state remains transmitted-unknown; no success/failure is invented and no unqualified duplicate order is sent
