# File plan — `runbooks/spec-034/distributed-contract.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-034/distributed-contract.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0199 operational/repair procedure

Scope: Define distributed and GPU execution lifecycle. This is a plan; deployments and commands not yet qualified remain blocked.
...
It reconciles by stable job identity rather than spawning uncontrolled duplicate jobs; budget and unknown state remain explicit
