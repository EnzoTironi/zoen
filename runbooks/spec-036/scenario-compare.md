# File plan — `runbooks/spec-036/scenario-compare.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-036/scenario-compare.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0208 operational/repair procedure

Scope: Compare scenarios with explicit basis and coverage. This is a plan; deployments and commands not yet qualified remain blocked.
...
The system explains incompatible metrics rather than presenting a misleading single winner
