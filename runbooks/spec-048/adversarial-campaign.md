# File plan — `runbooks/spec-048/adversarial-campaign.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-048/adversarial-campaign.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0284 operational/repair procedure

Scope: Run hostile-agent, supply-chain and privacy campaigns. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
Security/privacy campaigns run against actual admitted components
...
Any critical invariant violation blocks promotion; no test waiver hides a security failure
