# File plan — `runbooks/spec-033/live-journey.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-033/live-journey.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0196 operational/repair procedure

Scope: Prove capture freshness, entitlement and reconnect races. This is a plan; deployments and commands not yet qualified remain blocked.
...
The Case is stale and no effect is sent; a fresh proposal is required with a new explicit basis
