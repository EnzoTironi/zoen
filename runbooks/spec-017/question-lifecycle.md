# File plan — `runbooks/spec-017/question-lifecycle.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-017/question-lifecycle.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0104 operational/repair procedure

Scope: Support stale questions, unknown answers and reversals. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
The user answers the old message
...
The answer is rejected as stale and no obsolete claim selection occurs; unknown responses do not boost either candidate
