# File plan — `runbooks/spec-017/question-priority.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-017/question-priority.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0101 operational/repair procedure

Scope: Rank and deduplicate clarification candidates. This is a plan; deployments and commands not yet qualified remain blocked.
...
Only one equivalent mismatch question is queued and the consequential deadline question ranks ahead with an explainable basis
