# File plan — `runbooks/spec-014/activate.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-014/activate.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0086 operational/repair procedure

Scope: Activate with an exclusive head transition. This is a plan; deployments and commands not yet qualified remain blocked.
...
No partial switch occurs; it returns stale and requires fresh preparation rather than activating on approximate current data
