# File plan — `runbooks/spec-014/prepare.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-014/prepare.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0085 operational/repair procedure

Scope: Prepare data generations and open-work dispositions. This is a plan; deployments and commands not yet qualified remain blocked.
...
It never exposes mixed generations; ambiguous migration remains blocked and open Cases are explicitly disposed
