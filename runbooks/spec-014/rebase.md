# File plan — `runbooks/spec-014/rebase.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-014/rebase.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0087 operational/repair procedure

Scope: Implement concurrent edit rebase and forward repair. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
The second draft rebases and an operator requests rollback
...
Conflicting semantics are shown; rollback creates a new governed transition with no blind head rewrite
