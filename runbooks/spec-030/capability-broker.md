# File plan — `runbooks/spec-030/capability-broker.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-030/capability-broker.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0175 operational/repair procedure

Scope: Implement narrow lease and capability brokers. This is a plan; deployments and commands not yet qualified remain blocked.
...
The request is denied and no secret or cross-account information is exposed
