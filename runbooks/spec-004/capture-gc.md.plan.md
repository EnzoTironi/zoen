# File plan — `runbooks/spec-004/capture-gc.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-004/capture-gc.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0029 operational/repair procedure

Scope: Handle capture orphans and retention pins safely. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
Both contend for the same capture
...
An admitted/pinned artifact survives; an unreferenced expired orphan can be deleted; no accepted evidence points at GC-deleted bytes
