# File plan — `runbooks/spec-004/extract.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-004/extract.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0028 operational/repair procedure

Scope: Implement initial CSV and JSON extraction profiles. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
The extractor runs twice against identical bytes
...
Ambiguous parsing is quarantined; valid candidate claims and their evidence coordinates are deterministic
