# File plan — `runbooks/spec-004/file-journey.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-004/file-journey.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0030 operational/repair procedure

Scope: Prove the two-source file journey end to end. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
The user asks whether payment is verified
...
The Frame retains both sources, labels the assertion as unverified and never emits a provider Settlement
