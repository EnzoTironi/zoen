# File plan — `runbooks/spec-047/allocations.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-047/allocations.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0276 operational/repair procedure

Scope: Implement allocations and clearing obligations. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
The allocation workflow completes its first response
...
The result is partial and unallocated exposure remains explicit; no entire-trade settlement is inferred
