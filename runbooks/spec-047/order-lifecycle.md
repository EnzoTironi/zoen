# File plan — `runbooks/spec-047/order-lifecycle.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-047/order-lifecycle.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0273 operational/repair procedure

Scope: Implement order submission and acknowledged lifecycle. This is a plan; deployments and commands not yet qualified remain blocked.
...
The order remains unknown until reconciled and cannot be blindly submitted again with a new client order identity
