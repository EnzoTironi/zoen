# File plan — `runbooks/spec-047/cancel-replace.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-047/cancel-replace.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0275 operational/repair procedure

Scope: Handle cancel/replace, partial and fill races. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
Events arrive reordered and duplicated
...
The resulting open/filled/cancelled quantities are consistent with evidence; cancel requested is never treated as proof of no fill
