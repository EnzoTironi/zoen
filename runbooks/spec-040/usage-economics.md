# File plan — `runbooks/spec-040/usage-economics.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-040/usage-economics.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0232 operational/repair procedure

Scope: Attribute usage and cost without inventing actuals. This is a plan; deployments and commands not yet qualified remain blocked.
...
Estimated/unknown/actual costs stay distinct and aggregate budget exposure cannot be bypassed by child retries
