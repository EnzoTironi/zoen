# File plan — `runbooks/spec-040/audit-export.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-040/audit-export.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0234 operational/repair procedure

Scope: Implement security audit exports and incident runbooks. This is a plan; deployments and commands not yet qualified remain blocked.
...
Audit gaps are explicit, new runner permits stop and evidence is preserved without broad data disclosure
