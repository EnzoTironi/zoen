# File plan — `runbooks/spec-040/fairness.md`

**Status:** planned; no product acceptance implied.

Target: `runbooks/spec-040/fairness.md`. Representation: **markdown-plan**. Allocation: **required**.
...
## ZN-0231 operational/repair procedure

Scope: Enforce per-World quotas and fair scheduling. This is a plan; deployments and commands not yet qualified remain blocked.

```text
PRECHECK exact environment/profile, operator authority, ticket evidence and affected World/realm.
STOP new admissions/dispatch for the affected scope before destructive or ambiguous repair.
OBSERVE actual durable state and raw error at this ticket boundary:
The workload test runs
...
The flood is throttled within declared quotas and the second tenant meets the target latency/error envelope
